...
function Player:onLook(thing, position, distance)
	...
	if thing:isPokemon() then
		description = onLookPokemon(thing, description)
	elseif thing:isItem() and Pokeball(thing) then
		description = onLookPokeball(Pokeball(thing))
	elseif hasEventCallback(EVENT_CALLBACK_ONLOOK) then
...
function Player:onLookInBattleList(creature, distance)
	...
	if creature:isPokemon() then
		description = onLookPokemon(creature, description)
	elseif hasEventCallback(EVENT_CALLBACK_ONLOOKINBATTLELIST) then
...
function Player:onLookInTrade(partner, item, distance)
	...
	if Pokeball(item) then
		description = onLookPokeball(Pokeball(item))
	elseif hasEventCallback(EVENT_CALLBACK_ONLOOKINTRADE) then
