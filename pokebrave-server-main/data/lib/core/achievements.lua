...
achievements =
{
	...
	[55] = {name = "Masquerader", grade = 1, points = 3, secret = true, description = "You probably don't know anymore how you really look like - usually when you look into a mirror, some kind of pokemon stares back at you. On the other hand - maybe that's an improvement?"},
	...
	[111] = {name = "Cookie Pokemon", grade = 1, points = 1, secret = true, description = "You can easily be found by anyone if they just follow the cookie crumb trail. And for you, true love means to give away your last cookie."},
	...
	[351] = {name = "Robo Chop", grade = 1, points = 4, secret = true, description = "You have defeated the glooth bomb and chopped down a lot of metal pokemons on your way."},
	...
	[355] = {name = "Wail of the Banshee", grade = 1, points = 1, secret = true, description = "You saw the Crystal Gardens with all their stunning beauty and survived the equally impressive pokemons there. In the end you discovered a great evil and destroyed it with the help of a banshee who was not even aware of her support."},
	...
	[380] = {name = "Out of the Stone Age", grade = 1, points = 3, description = "What a blast from the past! This thankful patient thinks you missed your dentist profession. It's now ready to take a bite of the future and to carry you to your next adventure, or your next patient."},
