...
dofile('data/lib/core/general.lua')
...
dofile('data/lib/core/profession.lua')
dofile('data/lib/core/json.lua')
dofile('data/lib/core/hash.lua')
dofile('data/lib/core/spell.lua')
dofile('data/lib/core/signal.lua')
dofile('data/lib/core/module.lua')
dofile('data/lib/core/modulemanager.lua')
