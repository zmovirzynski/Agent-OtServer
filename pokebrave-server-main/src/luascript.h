...
struct LuaModuleTimerEventDesc {
	int32_t callback = -1;
	int32_t params = -1;
};
...
class LuaScriptInterface
{
	...
	private:
		...
		static int luaAddModuleEvent(lua_State* L);
		static int luaStopModuleEvent(lua_State* L);
		...
		static int luaGameGetModularityEnviroment(lua_State* L);
		static int luaGameGetLFSName(lua_State* L);
		...
		static int luaGameGetPokemonTypes(lua_State* L);
		static int luaGameGetPokeballInfo(lua_State* L);
		...
		static int luaGameCreatePokemonType(lua_State* L);
		...
		static int luaSpellsClear(lua_State* L);

		// Functions
		static int luaFunctionsGetPokemonNatureName(lua_State* L);
		static int luaFunctionsGetPokemonGenderName(lua_State* L);
		static int luaFunctionsGetPokemonTypeName(lua_State* L);
		static int luaFunctionsGetPokemonExpForLevel(lua_State* L);
		static int luaFunctionsGetPokemonMaxHealth(lua_State* L);
		...
		static int luaItemGetParentContainer(lua_State* L);
		...
		static int luaItemGetCorpseName(lua_State* L);
		static int luaItemGetPokemonCorpseIvs(lua_State* L);
		static int luaItemGetAttributes(lua_State* L);
		static int luaItemLoadAttributes(lua_State* L);

		static int luaItemIsCuttable(lua_State* L);
		static int luaItemIsSmashable(lua_State* L);
		static int luaItemIsDiggable(lua_State* L);
		...
		static int luaPokeballGetPokemon(lua_State* L);
		static int luaPokeballSetPokemon(lua_State* L);

		static int luaPokeballGetPokemonName(lua_State* L);
		static int luaPokeballSetPokemonName(lua_State* L);

		static int luaPokeballGetPokemonNickname(lua_State* L);
		static int luaPokeballSetPokemonNickname(lua_State* L);

		static int luaPokeballGetPokemonIvs(lua_State* L);
		static int luaPokeballSetPokemonIvs(lua_State* L);

		static int luaPokeballGetPokemonEvs(lua_State* L);
		static int luaPokeballSetPokemonEvs(lua_State* L);

		static int luaPokeballGetPokemonLevel(lua_State* L);
		static int luaPokeballSetPokemonLevel(lua_State* L);

		static int luaPokeballGetPokemonGender(lua_State* L);
		static int luaPokeballSetPokemonGender(lua_State* L);

		static int luaPokeballGetPokemonNature(lua_State* L);
		static int luaPokeballSetPokemonNature(lua_State* L);

		static int luaPokeballGetPokemonExperience(lua_State* L);
		static int luaPokeballSetPokemonExperience(lua_State* L);

		static int luaPokeballGetPokemonHealth(lua_State* L);
		static int luaPokeballSetPokemonHealth(lua_State* L);

		static int luaPokeballGetInfo(lua_State* L);
		static int luaPokeballSetInfoId(lua_State* L);

		static int luaPokeballGetState(lua_State* L);
		static int luaPokeballSetState(lua_State* L);

		static int luaPokeballGetPortrait(lua_State* L);
		static int luaPokeballSetPortrait(lua_State* L);

		static int luaPokeballRefresh(lua_State* L);

		static int luaPokeballGetIvsStats(lua_State* L);

		static int luaPokeballUpdatePokemonAbilities(lua_State* L);

		static int luaPokeballResetMoveCooldown(lua_State* L);
		static int luaPokeballGetMoveOsTime(lua_State* L);
		static int luaPokeballGetMoveCooldown(lua_State* L);

		static int luaPokeballGetMoves(lua_State* L);
		...
		static int luaCreatureJump(lua_State* L);

		static int luaCreatureGetZone(lua_State* L);

		static int luaCreatureAddTag(lua_State* L);
		static int luaCreatureAddTimedTag(lua_State* L);
		static int luaCreatureSetTag(lua_State* L);
		static int luaCreatureRemoveTag(lua_State* L);
		static int luaCreatureHasTag(lua_State* L);
		static int luaCreatureGetTag(lua_State* L);

		static int luaCreatureMoveToPosition(lua_State* L);
		...
		static int luaPlayerUpdateContainer(lua_State* L);
		static int luaPlayerUpdateContainerItem(lua_State* L);

		static int luaPlayerSendInventoryItem(lua_State* L);
		...
		static int luaPlayerGetPokemon(lua_State* L);
		static int luaPlayerSetPokemon(lua_State* L);

		static int luaPlayerGetPokeball(lua_State* L);
		static int luaPlayerSetPokeball(lua_State* L);

		static int luaPlayerGetItemFromPosition(lua_State* L);
		static int luaPlayerGetItemByAttribute(lua_State* L);

		static int luaPlayerIsFlying(lua_State* L);
		static int luaPlayerSetFlying(lua_State* L);
		...
		static int luaPokemonIsWalkingToSpawn(lua_State* L);
		static int luaPokemonWalkToSpawn(lua_State* L);

		static int luaPokemonGetLevel(lua_State* L);
		static int luaPokemonGetLevelPercent(lua_State* L);
		static int luaPokemonSetLevel(lua_State* L);

		static int luaPokemonGetExperience(lua_State* L);
		static int luaPokemonSetExperience(lua_State* L);

		static int luaPokemonGetGender(lua_State* L);
		static int luaPokemonSetGender(lua_State* L);

		static int luaPokemonGetIvs(lua_State* L);
		static int luaPokemonSetIvs(lua_State* L);

		static int luaPokemonGetEvs(lua_State* L);
		static int luaPokemonSetEvs(lua_State* L);

		static int luaPokemonSetEvAttack(lua_State* L);
		static int luaPokemonSetEvDefense(lua_State* L);
		static int luaPokemonSetEvHealth(lua_State* L);
		static int luaPokemonSetEvSpecialAttack(lua_State* L);
		static int luaPokemonSetEvSpecialDefense(lua_State* L);
		static int luaPokemonSetEvSpeed(lua_State* L);

		static int luaPokemonGetNature(lua_State* L);
		static int luaPokemonSetNature(lua_State* L);

		static int luaPokemonGetIvsStats(lua_State* L);

		static int luaPokemonUpdateMaxHealth(lua_State* L);
		static int luaPokemonUpdateSpeed(lua_State* L);
		static int luaPokemonUpdateStatus(lua_State* L);

		static int luaPokemonCastSpell(lua_State* L);
		static int luaPokemonGetMove(lua_State* L);
		static int luaPokemonLearnMove(lua_State* L);
		static int luaPokemonHasMoveId(lua_State* L);
		static int luaPokemonHasMoveByName(lua_State* L);

		static int luaPokemonEvolve(lua_State* L);

		static int luaPokemonLearnAbility(lua_State* L);
		static int luaPokemonHasAbility(lua_State* L);

		static int luaPokemonGetStatusHealth(lua_State* L);
		static int luaPokemonGetStatusAttack(lua_State* L);
		static int luaPokemonGetStatusDefense(lua_State* L);
		static int luaPokemonGetStatusSpecialAttack(lua_State* L);
		static int luaPokemonGetStatusSpecialDefense(lua_State* L);
		static int luaPokemonGetStatusSpeed(lua_State* L);

		static int luaPokemonIsHoldingPosition(lua_State* L);
		static int luaPokemonSetHoldPosition(lua_State* L);

		static int luaPokemonGetOrderPosition(lua_State* L);
		static int luaPokemonSetOrderPosition(lua_State* L);
		...
		static int luaProfessionAllowsPvp(lua_State* L);
		...
		static int luaItemTypeGetProfessionString(lua_State* L);
		...
		static int luaPokemonTypeIsChallengeable(lua_State* L);
		static int luaPokemonTypeIsConvinceable(lua_State* L);
		static int luaPokemonTypeIsSummonable(lua_State* L);
		static int luaPokemonTypeIsIgnoringSpawnBlock(lua_State* L);
		...
		static int luaPokemonTypeIsHealthHidden(lua_State* L);
		static int luaPokemonTypeIsBoss(lua_State* L);

		static int luaPokemonTypeCanPushItems(lua_State* L);
		static int luaPokemonTypeCanPushCreatures(lua_State* L);

		static int luaPokemonTypeCanWalkOnEnergy(lua_State* L);
		static int luaPokemonTypeCanWalkOnFire(lua_State* L);
		static int luaPokemonTypeCanWalkOnPoison(lua_State* L);

		static int luaPokemonTypeCanLearnAbility(lua_State* L);
		static int luaPokemonTypeCanLearnMove(lua_State* L);

		static int luaPokemonTypeName(lua_State* L);
		static int luaPokemonTypeNameDescription(lua_State* L);

		static int luaPokemonTypeGenderMalePercent(lua_State* L);
		static int luaPokemonTypeGenderFemalePercent(lua_State* L);
		static int luaPokemonTypeMinSpawnLevel(lua_State* L);
		static int luaPokemonTypeMaxSpawnLevel(lua_State* L);
		static int luaPokemonTypeHealth(lua_State* L);
		static int luaPokemonTypeMaxHealth(lua_State* L);
		static int luaPokemonTypeRunHealth(lua_State* L);
		static int luaPokemonTypeExperience(lua_State* L);
		static int luaPokemonTypeSkull(lua_State* L);

		static int luaPokemonTypeCatchRate(lua_State* L);
		static int luaPokemonTypePortrait(lua_State* L);

		static int luaPokemonTypeCombatImmunities(lua_State* L);
		static int luaPokemonTypeConditionImmunities(lua_State* L);

		static int luaPokemonTypeAddMove(lua_State* L);
		static int luaPokemonTypeAddLearnableAbility(lua_State* L);
		static int luaPokemonTypeAddLearnableMove(lua_State* L);
		static int luaPokemonTypeAddEvolution(lua_State* L);
		...
		static int luaPokemonTypeAddElement(lua_State* L);

		static int luaPokemonTypeGetVoices(lua_State* L);
		static int luaPokemonTypeAddVoice(lua_State* L);

		static int luaPokemonTypeGetLoot(lua_State* L);
		static int luaPokemonTypeAddLoot(lua_State* L);

		static int luaPokemonTypeEventOnCallback(lua_State* L);
		static int luaPokemonTypeEventType(lua_State* L);

		static int luaPokemonTypeGetSummonList(lua_State* L);
		static int luaPokemonTypeAddSummon(lua_State* L);

		static int luaPokemonTypeMaxSummons(lua_State* L);

		static int luaPokemonTypeArmor(lua_State* L);
		static int luaPokemonTypeDefense(lua_State* L);
		static int luaPokemonTypeOutfit(lua_State* L);
		static int luaPokemonTypeFirstType(lua_State* L);
		static int luaPokemonTypeSecondType(lua_State* L);
		static int luaPokemonTypeCorpseId(lua_State* L);
		static int luaPokemonTypeLight(lua_State* L);

		static int luaPokemonTypeStaticAttackChance(lua_State* L);
		static int luaPokemonTypeTargetDistance(lua_State* L);
		static int luaPokemonTypeYellChance(lua_State* L);
		static int luaPokemonTypeYellSpeedTicks(lua_State* L);
		static int luaPokemonTypeChangeTargetChance(lua_State* L);
		static int luaPokemonTypeChangeTargetSpeed(lua_State* L);

		static int luaPokemonTypeGetEvolutions(lua_State* L);
		static int luaPokemonTypeGetMoves(lua_State* L);

		static int luaPokemonTypeNationalNumber(lua_State* L);
		static int luaPokemonTypeDescription(lua_State* L);
		static int luaPokemonTypeHeight(lua_State* L);
		static int luaPokemonTypeWeight(lua_State* L);

		static int luaPokemonTypeGetRandomGender(lua_State* L);
		static int luaPokemonTypeRequiredLevel(lua_State* L);

		static int luaPokemonTypeBaseHealth(lua_State* L);
		static int luaPokemonTypeBaseAttack(lua_State* L);
		static int luaPokemonTypeBaseDefense(lua_State* L);
		static int luaPokemonTypeBaseSpecialAttack(lua_State* L);
		static int luaPokemonTypeBaseSpecialDefense(lua_State* L);
		...
		static int luaSpellProfession(lua_State* L);
		...
		static int luaMoveEventProfession(lua_State* L);
...
class LuaEnvironment : public LuaScriptInterface
{
	...
	private:
		...
		void executeModuleEvent(uint32_t eventIndex, int32_t callback, int32_t tableRef = -1);

		std::unordered_map<uint32_t, LuaModuleTimerEventDesc> moduleTimerEvents;
