...
const std::unordered_map<std::string, PokemonType_t> RaceTypesMap = {
	{"venom", POKEMON_TYPE_POISON},
	{"blood", POKEMON_TYPE_NORMAL},
	{"undead", POKEMON_TYPE_BUG},
	{"fire", POKEMON_TYPE_FIRE},
	{"energy", POKEMON_TYPE_ELETRIC},
};
		...
		if (parseAttribute != ItemParseAttributesMap.end()) {
			...
			switch (parseType) {
				...
				case ITEM_PARSE_FIELDABSORBPERCENTENERGY: {
					abilities.fieldAbsorbPercent[combatTypeToIndex(COMBAT_ELETRICDAMAGE)] += pugi::cast<int16_t>(valueAttribute.value());
					break;
				}
				...
				case ITEM_PARSE_FIELDABSORBPERCENTPOISON: {
					abilities.fieldAbsorbPercent[combatTypeToIndex(COMBAT_ROCKDAMAGE)] += pugi::cast<int16_t>(valueAttribute.value());
					break;
				}
				...
				case ITEM_PARSE_ABSORBPERCENTELEMENTS: {
					int16_t value = pugi::cast<int16_t>(valueAttribute.value());
					abilities.absorbPercent[combatTypeToIndex(COMBAT_ELETRICDAMAGE)] += value;
					abilities.absorbPercent[combatTypeToIndex(COMBAT_FIREDAMAGE)] += value;
					abilities.absorbPercent[combatTypeToIndex(COMBAT_ROCKDAMAGE)] += value;
				...
				case ITEM_PARSE_ABSORBPERCENTMAGIC: {
					...
					abilities.absorbPercent[combatTypeToIndex(COMBAT_ROCKDAMAGE)] += value;
					abilities.absorbPercent[combatTypeToIndex(COMBAT_ICEDAMAGE)] += value;
					abilities.absorbPercent[combatTypeToIndex(COMBAT_PSYCHICDAMAGE)] += value;
					abilities.absorbPercent[combatTypeToIndex(COMBAT_WATERDAMAGE)] += value;
					break;
				}

				case ITEM_PARSE_ABSORBPERCENTENERGY: {
					abilities.absorbPercent[combatTypeToIndex(COMBAT_ELETRICDAMAGE)] += pugi::cast<int16_t>(valueAttribute.value());
					break;
				}
				...
				case ITEM_PARSE_ABSORBPERCENTPOISON: {
					abilities.absorbPercent[combatTypeToIndex(COMBAT_ROCKDAMAGE)] += pugi::cast<int16_t>(valueAttribute.value());
					break;
				}
				...
				case ITEM_PARSE_ABSORBPERCENTHOLY: {
					abilities.absorbPercent[combatTypeToIndex(COMBAT_PSYCHICDAMAGE)] += pugi::cast<int16_t>(valueAttribute.value());
					break;
				}
				...
				case ITEM_PARSE_ABSORBPERCENTDROWN: {
					abilities.absorbPercent[combatTypeToIndex(COMBAT_BUGDAMAGE)] += pugi::cast<int16_t>(valueAttribute.value());
					break;
				}

				case ITEM_PARSE_ABSORBPERCENTPHYSICAL: {
					abilities.absorbPercent[combatTypeToIndex(COMBAT_NORMALDAMAGE)] += pugi::cast<int16_t>(valueAttribute.value());
					break;
				}
				...
				case ITEM_PARSE_ABSORBPERCENTUNDEFINED: {
					abilities.absorbPercent[combatTypeToIndex(COMBAT_GRASSDAMAGE)] += pugi::cast<int16_t>(valueAttribute.value());
					break;
				}
				...
				case ITEM_PARSE_ELEMENTEARTH: {
					abilities.elementDamage = pugi::cast<uint16_t>(valueAttribute.value());
					abilities.elementType = COMBAT_ROCKDAMAGE;
					break;
				}
				...
				case ITEM_PARSE_ELEMENTENERGY: {
					abilities.elementDamage = pugi::cast<uint16_t>(valueAttribute.value());
					abilities.elementType = COMBAT_ELETRICDAMAGE;
					break;
				}
				...
				case ITEM_PARSE_ELEMENTHOLY: {
					abilities.elementDamage = pugi::cast<uint16_t>(valueAttribute.value());
					abilities.elementType = COMBAT_PSYCHICDAMAGE;
					break;
				}
