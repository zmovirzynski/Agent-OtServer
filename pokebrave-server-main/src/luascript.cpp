...
void LuaScriptInterface::reportError(const char* function, const std::string& error_desc, lua_State* L /*= nullptr*/, bool stack_trace /*= false*/)
{
	...
	if (env) {
		env->getEventInfo(scriptId, scriptInterface, callbackId, timerEvent);
...
Thing* LuaScriptInterface::getThing(lua_State* L, int32_t arg)
{
	...
	if (lua_getmetatable(L, arg) != 0) {
		...
		if (env)
			thing = env->getThingByUID(getNumber<uint32_t>(L, arg));
	}
	return thing;
}
...
void LuaScriptInterface::registerFunctions()
{
	...
	//addModuleEvent(callback, delay, params)
	lua_register(luaState, "addModuleEvent", LuaScriptInterface::luaAddModuleEvent);

	//stopModuleEvent(eventIndex)
	lua_register(luaState, "stopModuleEvent", LuaScriptInterface::luaStopModuleEvent);
	...
	registerEnum(COMBAT_ELETRICDAMAGE)
	...
	registerEnum(COMBAT_PARAM_POWER)
	...
	registerEnum(ITEM_ATTRIBUTE_CORPSENAME)
	registerEnum(ITEM_ATTRIBUTE_POKEMONCORPSELEVEL)
	...
	registerEnum(TEXTCOLOR_FORESTGREEN)
	registerEnum(TEXTCOLOR_DARKMAGENTA)
	...
	registerEnum(TEXTCOLOR_SADDLEBROWN)
	registerEnum(TEXTCOLOR_OLIVE)
	registerEnum(TEXTCOLOR_LIGHTGREY)
	registerEnum(TEXTCOLOR_LAWNGREEN)
	registerEnum(TEXTCOLOR_SKYBLUE)
	registerEnum(TEXTCOLOR_PURPLE)
	registerEnum(TEXTCOLOR_ELECTRICPURPLE)
	registerEnum(TEXTCOLOR_SIENNA)
	registerEnum(TEXTCOLOR_ROSYBROWN)
	registerEnum(TEXTCOLOR_DARKKHAKI)
	registerEnum(TEXTCOLOR_SILVER)
	registerEnum(TEXTCOLOR_LIGHTSTEELBLUE)
	registerEnum(TEXTCOLOR_RED)
	registerEnum(TEXTCOLOR_FUCHSIA)
	registerEnum(TEXTCOLOR_PINK)
	registerEnum(TEXTCOLOR_PASTELRED)
	registerEnum(TEXTCOLOR_ORANGE)
	registerEnum(TEXTCOLOR_ORCHID)
	registerEnum(TEXTCOLOR_GOLD)
	registerEnum(TEXTCOLOR_PALEPINK)
	registerEnum(TEXTCOLOR_YELLOW)
	registerEnum(TEXTCOLOR_KHAKI)
	...
	registerEnum(MAPMARK_POKEMONCENTER)
	...
	// Use with pokemon:setGender
	registerEnum(POKEMON_GENDER_UNDEFINED)
	registerEnum(POKEMON_GENDER_MALE)
	registerEnum(POKEMON_GENDER_FEMALE)
	registerEnum(POKEMON_GENDER_LAST)

	// Use with pokemon:setNature
	registerEnum(POKEMON_NATURE_HARDY)
	registerEnum(POKEMON_NATURE_LONELY)
	registerEnum(POKEMON_NATURE_ADAMANT)
	registerEnum(POKEMON_NATURE_NAUGHTY)
	registerEnum(POKEMON_NATURE_BRAVE)
	registerEnum(POKEMON_NATURE_BOLD)
	registerEnum(POKEMON_NATURE_DOCILE)
	registerEnum(POKEMON_NATURE_IMPISH)
	registerEnum(POKEMON_NATURE_LAX)
	registerEnum(POKEMON_NATURE_RELAXED)
	registerEnum(POKEMON_NATURE_MODEST)
	registerEnum(POKEMON_NATURE_MILD)
	registerEnum(POKEMON_NATURE_BASHFUL)
	registerEnum(POKEMON_NATURE_RASH)
	registerEnum(POKEMON_NATURE_QUIET)
	registerEnum(POKEMON_NATURE_CALM)
	registerEnum(POKEMON_NATURE_GENTLE)
	registerEnum(POKEMON_NATURE_CAREFUL)
	registerEnum(POKEMON_NATURE_QUIRKY)
	registerEnum(POKEMON_NATURE_SASSY)
	registerEnum(POKEMON_NATURE_TIMID)
	registerEnum(POKEMON_NATURE_HASTY)
	registerEnum(POKEMON_NATURE_JOLLY)
	registerEnum(POKEMON_NATURE_NAIVE)
	registerEnum(POKEMON_NATURE_SERIOUS)
	registerEnum(POKEMON_NATURE_LAST)

	// Use with pokeball:setStatus
	registerEnum(POKEBALL_STATE_OFF)
	registerEnum(POKEBALL_STATE_ON)
	registerEnum(POKEBALL_STATE_FAINTED)
	...
	registerEnum(RETURNVALUE_YOURPROFESSIONCANNOTUSETHISSPELL)
	...
	registerEnum(RETURNVALUE_POKEMONCANNOTEVOLVE)
	registerEnum(RETURNVALUE_POKEMONCANNOTEVOLVEWITHTHISSTONE)
	registerEnum(RETURNVALUE_POKEMONEVOLUTIONNOTFOUND)
	registerEnum(RETURNVALUE_NOLEVELTOEVOLVEPOKEMON)
	...
	registerEnum(POKEMONS_EVENT_THINK)
	registerEnum(POKEMONS_EVENT_APPEAR)
	registerEnum(POKEMONS_EVENT_DISAPPEAR)
	registerEnum(POKEMONS_EVENT_MOVE)
	registerEnum(POKEMONS_EVENT_SAY)

	registerEnum(MAX_POKEMON_IV_VALUE)
	registerEnum(MAX_POKEMON_EV_VALUE)
	registerEnum(MAX_POKEMON_LEVEL)

	registerEnum(POKEMON_TYPE_NONE)
	registerEnum(POKEMON_TYPE_POISON)
	registerEnum(POKEMON_TYPE_NORMAL)
	registerEnum(POKEMON_TYPE_BUG)
	registerEnum(POKEMON_TYPE_FIRE)
	registerEnum(POKEMON_TYPE_ELETRIC)
	registerEnum(POKEMON_TYPE_FAIRY)
	registerEnum(POKEMON_TYPE_GROUND)
	registerEnum(POKEMON_TYPE_ROCK)
	registerEnum(POKEMON_TYPE_ICE)
	registerEnum(POKEMON_TYPE_WATER)
	registerEnum(POKEMON_TYPE_FLYING)
	registerEnum(POKEMON_TYPE_GRASS)
	registerEnum(POKEMON_TYPE_FIGHTING)
	registerEnum(POKEMON_TYPE_PSYCHIC)
	registerEnum(POKEMON_TYPE_STEEL)
	registerEnum(POKEMON_TYPE_GHOST)
	registerEnum(POKEMON_TYPE_DRAGON)

	// items
	registerEnum(INVISIBLE_TILE_ID)

  // Player Storages
	registerEnum(PLAYER_STORAGE_FLY)
	...
	registerEnumIn("configKeys", ConfigManager::RATE_POKEDEX)
	...
	registerMethod("Game", "getPokemonTypes", LuaScriptInterface::luaGameGetPokemonTypes);
	registerMethod("Game", "getPokeballInfo", LuaScriptInterface::luaGameGetPokeballInfo);
	...
	registerMethod("Game", "getModularityEnviroment", LuaScriptInterface::luaGameGetModularityEnviroment);
	registerMethod("Game", "getLFSName", LuaScriptInterface::luaGameGetLFSName);
	...
	registerMethod("Game", "createPokemonType", LuaScriptInterface::luaGameCreatePokemonType);
	...
	// Spells
	registerTable("Spells");

	registerMethod("Spells", "clear", LuaScriptInterface::luaSpellsClear);

	// Functions
	registerTable("Functions");

	registerMethod("Functions", "getPokemonNatureName", LuaScriptInterface::luaFunctionsGetPokemonNatureName);
	registerMethod("Functions", "getPokemonGenderName", LuaScriptInterface::luaFunctionsGetPokemonGenderName);
	registerMethod("Functions", "getPokemonTypeName", LuaScriptInterface::luaFunctionsGetPokemonTypeName);
	registerMethod("Functions", "getPokemonExpForLevel", LuaScriptInterface::luaFunctionsGetPokemonExpForLevel);
	registerMethod("Functions", "getPokemonMaxHealth", LuaScriptInterface::luaFunctionsGetPokemonMaxHealth);
	...
	registerMethod("Item", "getParentContainer", LuaScriptInterface::luaItemGetParentContainer);
	...
	registerMethod("Item", "getCorpseName", LuaScriptInterface::luaItemGetCorpseName);
	registerMethod("Item", "getPokemonCorpseIvs", LuaScriptInterface::luaItemGetPokemonCorpseIvs);
	...
	registerMethod("Item", "isCuttable", LuaScriptInterface::luaItemIsCuttable);
	registerMethod("Item", "isSmashable", LuaScriptInterface::luaItemIsSmashable);
	registerMethod("Item", "isDiggable", LuaScriptInterface::luaItemIsDiggable);
	...
	registerMethod("Pokeball", "getPokemon", LuaScriptInterface::luaPokeballGetPokemon);
	registerMethod("Pokeball", "setPokemon", LuaScriptInterface::luaPokeballSetPokemon);
	...
	registerMethod("Pokeball", "getPokemonNickname", LuaScriptInterface::luaPokeballGetPokemonNickname);
	registerMethod("Pokeball", "setPokemonNickname", LuaScriptInterface::luaPokeballSetPokemonNickname);

	registerMethod("Pokeball", "getPokemonIvs", LuaScriptInterface::luaPokeballGetPokemonIvs);
	registerMethod("Pokeball", "setPokemonIvs", LuaScriptInterface::luaPokeballSetPokemonIvs);

	registerMethod("Pokeball", "getPokemonEvs", LuaScriptInterface::luaPokeballGetPokemonEvs);
	registerMethod("Pokeball", "setPokemonEvs", LuaScriptInterface::luaPokeballSetPokemonEvs);

	registerMethod("Pokeball", "getPokemonLevel", LuaScriptInterface::luaPokeballGetPokemonLevel);
	registerMethod("Pokeball", "setPokemonLevel", LuaScriptInterface::luaPokeballSetPokemonLevel);

	registerMethod("Pokeball", "getPokemonGender", LuaScriptInterface::luaPokeballGetPokemonGender);
	registerMethod("Pokeball", "setPokemonGender", LuaScriptInterface::luaPokeballSetPokemonGender);

	registerMethod("Pokeball", "getPokemonNature", LuaScriptInterface::luaPokeballGetPokemonNature);
	registerMethod("Pokeball", "setPokemonNature", LuaScriptInterface::luaPokeballSetPokemonNature);

	registerMethod("Pokeball", "getPokemonExperience", LuaScriptInterface::luaPokeballGetPokemonExperience);
	registerMethod("Pokeball", "setPokemonExperience", LuaScriptInterface::luaPokeballSetPokemonExperience);

	registerMethod("Pokeball", "getPokemonHealth", LuaScriptInterface::luaPokeballGetPokemonHealth);
	registerMethod("Pokeball", "setPokemonHealth", LuaScriptInterface::luaPokeballSetPokemonHealth);

	registerMethod("Pokeball", "getInfo", LuaScriptInterface::luaPokeballGetInfo);
	registerMethod("Pokeball", "setInfoId", LuaScriptInterface::luaPokeballSetInfoId);

	registerMethod("Pokeball", "getState", LuaScriptInterface::luaPokeballGetState);
	registerMethod("Pokeball", "setState", LuaScriptInterface::luaPokeballSetState);

	registerMethod("Pokeball", "getPortrait", LuaScriptInterface::luaPokeballGetPortrait);
	registerMethod("Pokeball", "setPortrait", LuaScriptInterface::luaPokeballSetPortrait);

	registerMethod("Pokeball", "refresh", LuaScriptInterface::luaPokeballRefresh);

	registerMethod("Pokeball", "getIvsStats", LuaScriptInterface::luaPokeballGetIvsStats);

	registerMethod("Pokeball", "updatePokemonAbilities", LuaScriptInterface::luaPokeballUpdatePokemonAbilities);

	registerMethod("Pokeball", "resetMoveCooldown", LuaScriptInterface::luaPokeballResetMoveCooldown);
	registerMethod("Pokeball", "getMoveOsTime", LuaScriptInterface::luaPokeballGetMoveOsTime);
	registerMethod("Pokeball", "getMoveCooldown", LuaScriptInterface::luaPokeballGetMoveCooldown);

	registerMethod("Pokeball", "getMoves", LuaScriptInterface::luaPokeballGetMoves);
	...
	registerMethod("Creature", "jump", LuaScriptInterface::luaCreatureJump);

	registerMethod("Creature", "getZone", LuaScriptInterface::luaCreatureGetZone);

	registerMethod("Creature", "addTag", LuaScriptInterface::luaCreatureAddTag);
	registerMethod("Creature", "addTimedTag", LuaScriptInterface::luaCreatureAddTimedTag);
	registerMethod("Creature", "setTag", LuaScriptInterface::luaCreatureSetTag);
	registerMethod("Creature", "removeTag", LuaScriptInterface::luaCreatureRemoveTag);
	registerMethod("Creature", "hasTag", LuaScriptInterface::luaCreatureHasTag);
	registerMethod("Creature", "getTag", LuaScriptInterface::luaCreatureGetTag);

	registerMethod("Creature", "moveToPosition", LuaScriptInterface::luaCreatureMoveToPosition);
	...
	registerMethod("Player", "updateContainer", LuaScriptInterface::luaPlayerUpdateContainer);
	registerMethod("Player", "updateContainerItem", LuaScriptInterface::luaPlayerUpdateContainerItem);
	registerMethod("Player", "sendInventoryItem", LuaScriptInterface::luaPlayerSendInventoryItem);
	...
	registerMethod("Player", "getPokemon", LuaScriptInterface::luaPlayerGetPokemon);
	registerMethod("Player", "setPokemon", LuaScriptInterface::luaPlayerSetPokemon);

	registerMethod("Player", "getPokeball", LuaScriptInterface::luaPlayerGetPokeball);
	registerMethod("Player", "setPokeball", LuaScriptInterface::luaPlayerSetPokeball);
	...
	registerMethod("Player", "isFlying", LuaScriptInterface::luaPlayerIsFlying);
	registerMethod("Player", "setFlying", LuaScriptInterface::luaPlayerSetFlying);
	...
	registerMethod("Pokemon", "isWalkingToSpawn", LuaScriptInterface::luaPokemonIsWalkingToSpawn);
	registerMethod("Pokemon", "walkToSpawn", LuaScriptInterface::luaPokemonWalkToSpawn);

	registerMethod("Pokemon", "getLevel", LuaScriptInterface::luaPokemonGetLevel);
	registerMethod("Pokemon", "getLevelPercent", LuaScriptInterface::luaPokemonGetLevelPercent);
	...
	registerMethod("Pokemon", "setExperience", LuaScriptInterface::luaPokemonSetExperience);

	registerMethod("Pokemon", "getGender", LuaScriptInterface::luaPokemonGetGender);
	registerMethod("Pokemon", "setGender", LuaScriptInterface::luaPokemonSetGender);

	registerMethod("Pokemon", "getIvs", LuaScriptInterface::luaPokemonGetIvs);
	registerMethod("Pokemon", "setIvs", LuaScriptInterface::luaPokemonSetIvs);

	registerMethod("Pokemon", "getEvs", LuaScriptInterface::luaPokemonGetEvs);
	registerMethod("Pokemon", "setEvs", LuaScriptInterface::luaPokemonSetEvs);

	registerMethod("Pokemon", "setEvAttack", LuaScriptInterface::luaPokemonSetEvAttack);
	registerMethod("Pokemon", "setEvDefense", LuaScriptInterface::luaPokemonSetEvDefense);
	registerMethod("Pokemon", "setEvHealth", LuaScriptInterface::luaPokemonSetEvHealth);
	registerMethod("Pokemon", "setEvSpecialAttack", LuaScriptInterface::luaPokemonSetEvSpecialAttack);
	registerMethod("Pokemon", "setEvSpecialDefense", LuaScriptInterface::luaPokemonSetEvSpecialDefense);
	registerMethod("Pokemon", "setEvSpeed", LuaScriptInterface::luaPokemonSetEvSpeed);

	registerMethod("Pokemon", "getNature", LuaScriptInterface::luaPokemonGetNature);
	registerMethod("Pokemon", "setNature", LuaScriptInterface::luaPokemonSetNature);

	registerMethod("Pokemon", "getIvsStats", LuaScriptInterface::luaPokemonGetIvsStats);

	registerMethod("Pokemon", "updateMaxHealth", LuaScriptInterface::luaPokemonUpdateMaxHealth);
	registerMethod("Pokemon", "updateSpeed", LuaScriptInterface::luaPokemonUpdateSpeed);
	registerMethod("Pokemon", "updateStatus", LuaScriptInterface::luaPokemonUpdateStatus);

	registerMethod("Pokemon", "castSpell", LuaScriptInterface::luaPokemonCastSpell);
	registerMethod("Pokemon", "getMove", LuaScriptInterface::luaPokemonGetMove);
	registerMethod("Pokemon", "learnMove", LuaScriptInterface::luaPokemonLearnMove);
	registerMethod("Pokemon", "hasMoveId", LuaScriptInterface::luaPokemonHasMoveId);
	registerMethod("Pokemon", "hasMoveByName", LuaScriptInterface::luaPokemonHasMoveByName);
	registerMethod("Pokemon", "evolve", LuaScriptInterface::luaPokemonEvolve);

	registerMethod("Pokemon", "learnAbility", LuaScriptInterface::luaPokemonLearnAbility);
	registerMethod("Pokemon", "hasAbility", LuaScriptInterface::luaPokemonHasAbility);

	registerMethod("Pokemon", "getStatusHealth", LuaScriptInterface::luaPokemonGetStatusHealth);
	registerMethod("Pokemon", "getStatusAttack", LuaScriptInterface::luaPokemonGetStatusAttack);
	registerMethod("Pokemon", "getStatusDefense", LuaScriptInterface::luaPokemonGetStatusDefense);
	registerMethod("Pokemon", "getStatusSpecialAttack", LuaScriptInterface::luaPokemonGetStatusSpecialAttack);
	registerMethod("Pokemon", "getStatusSpecialDefense", LuaScriptInterface::luaPokemonGetStatusSpecialDefense);
	registerMethod("Pokemon", "getStatusSpeed", LuaScriptInterface::luaPokemonGetStatusSpeed);

	registerMethod("Pokemon", "isHoldingPosition", LuaScriptInterface::luaPokemonIsHoldingPosition);
	registerMethod("Pokemon", "setHoldPosition", LuaScriptInterface::luaPokemonSetHoldPosition);

	registerMethod("Pokemon", "getOrderPosition", LuaScriptInterface::luaPokemonGetOrderPosition);
	registerMethod("Pokemon", "setOrderPosition", LuaScriptInterface::luaPokemonSetOrderPosition);
	...
	registerMethod("Profession", "getAttackSpeed", LuaScriptInterface::luaProfessionGetAttackSpeed);
	...
	registerMethod("Profession", "allowsPvp", LuaScriptInterface::luaProfessionAllowsPvp);
	...
	registerMethod("ItemType", "getProfessionString", LuaScriptInterface::luaItemTypeGetProfessionString);
	...
	registerMethod("PokemonType", "isChallengeable", LuaScriptInterface::luaPokemonTypeIsChallengeable);
	...
	registerMethod("PokemonType", "isIgnoringSpawnBlock", LuaScriptInterface::luaPokemonTypeIsIgnoringSpawnBlock);
	...
	registerMethod("PokemonType", "isHealthHidden", LuaScriptInterface::luaPokemonTypeIsHealthHidden);
	registerMethod("PokemonType", "isBoss", LuaScriptInterface::luaPokemonTypeIsBoss);
	...
	registerMethod("PokemonType", "canWalkOnEnergy", LuaScriptInterface::luaPokemonTypeCanWalkOnEnergy);
	registerMethod("PokemonType", "canWalkOnFire", LuaScriptInterface::luaPokemonTypeCanWalkOnFire);
	registerMethod("PokemonType", "canWalkOnPoison", LuaScriptInterface::luaPokemonTypeCanWalkOnPoison);

	registerMethod("PokemonType", "canLearnAbility", LuaScriptInterface::luaPokemonTypeCanLearnAbility);
	registerMethod("PokemonType", "canLearnMove", LuaScriptInterface::luaPokemonTypeCanLearnMove);

	registerMethod("PokemonType", "name", LuaScriptInterface::luaPokemonTypeName);
	registerMethod("PokemonType", "nameDescription", LuaScriptInterface::luaPokemonTypeNameDescription);

	registerMethod("PokemonType", "genderMalePercent", LuaScriptInterface::luaPokemonTypeGenderMalePercent);
	registerMethod("PokemonType", "genderFemalePercent", LuaScriptInterface::luaPokemonTypeGenderFemalePercent);
	registerMethod("PokemonType", "minSpawnLevel", LuaScriptInterface::luaPokemonTypeMinSpawnLevel);
	registerMethod("PokemonType", "maxSpawnLevel", LuaScriptInterface::luaPokemonTypeMaxSpawnLevel);
	registerMethod("PokemonType", "health", LuaScriptInterface::luaPokemonTypeHealth);
	registerMethod("PokemonType", "maxHealth", LuaScriptInterface::luaPokemonTypeMaxHealth);
	registerMethod("PokemonType", "runHealth", LuaScriptInterface::luaPokemonTypeRunHealth);
	registerMethod("PokemonType", "experience", LuaScriptInterface::luaPokemonTypeExperience);
	registerMethod("PokemonType", "skull", LuaScriptInterface::luaPokemonTypeSkull);

	registerMethod("PokemonType", "catchRate", LuaScriptInterface::luaPokemonTypeCatchRate);
	registerMethod("PokemonType", "portrait", LuaScriptInterface::luaPokemonTypePortrait);

	registerMethod("PokemonType", "combatImmunities", LuaScriptInterface::luaPokemonTypeCombatImmunities);
	registerMethod("PokemonType", "conditionImmunities", LuaScriptInterface::luaPokemonTypeConditionImmunities);

	registerMethod("PokemonType", "addMove", LuaScriptInterface::luaPokemonTypeAddMove);
	registerMethod("PokemonType", "addLearnableAbility", LuaScriptInterface::luaPokemonTypeAddLearnableAbility);
	registerMethod("PokemonType", "addLearnableMove", LuaScriptInterface::luaPokemonTypeAddLearnableMove);
	registerMethod("PokemonType", "addEvolution", LuaScriptInterface::luaPokemonTypeAddEvolution);
	...
	registerMethod("PokemonType", "addElement", LuaScriptInterface::luaPokemonTypeAddElement);

	registerMethod("PokemonType", "getVoices", LuaScriptInterface::luaPokemonTypeGetVoices);
	registerMethod("PokemonType", "addVoice", LuaScriptInterface::luaPokemonTypeAddVoice);

	registerMethod("PokemonType", "getLoot", LuaScriptInterface::luaPokemonTypeGetLoot);
	registerMethod("PokemonType", "addLoot", LuaScriptInterface::luaPokemonTypeAddLoot);

	registerMethod("PokemonType", "eventType", LuaScriptInterface::luaPokemonTypeEventType);
	registerMethod("PokemonType", "onThink", LuaScriptInterface::luaPokemonTypeEventOnCallback);
	registerMethod("PokemonType", "onAppear", LuaScriptInterface::luaPokemonTypeEventOnCallback);
	registerMethod("PokemonType", "onDisappear", LuaScriptInterface::luaPokemonTypeEventOnCallback);
	registerMethod("PokemonType", "onMove", LuaScriptInterface::luaPokemonTypeEventOnCallback);
	registerMethod("PokemonType", "onSay", LuaScriptInterface::luaPokemonTypeEventOnCallback);

	registerMethod("PokemonType", "getSummonList", LuaScriptInterface::luaPokemonTypeGetSummonList);
	registerMethod("PokemonType", "addSummon", LuaScriptInterface::luaPokemonTypeAddSummon);

	registerMethod("PokemonType", "maxSummons", LuaScriptInterface::luaPokemonTypeMaxSummons);

	registerMethod("PokemonType", "armor", LuaScriptInterface::luaPokemonTypeArmor);
	registerMethod("PokemonType", "defense", LuaScriptInterface::luaPokemonTypeDefense);
	registerMethod("PokemonType", "outfit", LuaScriptInterface::luaPokemonTypeOutfit);
	registerMethod("PokemonType", "firstType", LuaScriptInterface::luaPokemonTypeFirstType);
	registerMethod("PokemonType", "secondType", LuaScriptInterface::luaPokemonTypeSecondType);
	...
	registerMethod("PokemonType", "staticAttackChance", LuaScriptInterface::luaPokemonTypeStaticAttackChance);
	registerMethod("PokemonType", "targetDistance", LuaScriptInterface::luaPokemonTypeTargetDistance);
	registerMethod("PokemonType", "yellChance", LuaScriptInterface::luaPokemonTypeYellChance);
	...
	registerMethod("PokemonType", "getEvolutions", LuaScriptInterface::luaPokemonTypeGetEvolutions);
	registerMethod("PokemonType", "getMoves", LuaScriptInterface::luaPokemonTypeGetMoves);

	registerMethod("PokemonType", "nationalNumber", LuaScriptInterface::luaPokemonTypeNationalNumber);
	registerMethod("PokemonType", "description", LuaScriptInterface::luaPokemonTypeDescription);
	...
	registerMethod("PokemonType", "getRandomGender", LuaScriptInterface::luaPokemonTypeGetRandomGender);
	registerMethod("PokemonType", "requiredLevel", LuaScriptInterface::luaPokemonTypeRequiredLevel);

	registerMethod("PokemonType", "baseHealth", LuaScriptInterface::luaPokemonTypeBaseHealth);
	registerMethod("PokemonType", "baseAttack", LuaScriptInterface::luaPokemonTypeBaseAttack);
	registerMethod("PokemonType", "baseDefense", LuaScriptInterface::luaPokemonTypeBaseDefense);
	registerMethod("PokemonType", "baseSpecialAttack", LuaScriptInterface::luaPokemonTypeBaseSpecialAttack);
	registerMethod("PokemonType", "baseSpecialDefense", LuaScriptInterface::luaPokemonTypeBaseSpecialDefense);
	...
	// PokemonSpell
	registerClass("PokemonSpell", "", LuaScriptInterface::luaCreatePokemonSpell);
	registerMetaMethod("PokemonSpell", "__gc", LuaScriptInterface::luaDeletePokemonSpell);
	registerMethod("PokemonSpell", "delete", LuaScriptInterface::luaDeletePokemonSpell);

	registerMethod("PokemonSpell", "setType", LuaScriptInterface::luaPokemonSpellSetType);
	registerMethod("PokemonSpell", "setScriptName", LuaScriptInterface::luaPokemonSpellSetScriptName);
	registerMethod("PokemonSpell", "setChance", LuaScriptInterface::luaPokemonSpellSetChance);
	registerMethod("PokemonSpell", "setInterval", LuaScriptInterface::luaPokemonSpellSetInterval);
	registerMethod("PokemonSpell", "setRange", LuaScriptInterface::luaPokemonSpellSetRange);
	registerMethod("PokemonSpell", "setCombatValue", LuaScriptInterface::luaPokemonSpellSetCombatValue);
	registerMethod("PokemonSpell", "setCombatType", LuaScriptInterface::luaPokemonSpellSetCombatType);
	registerMethod("PokemonSpell", "setAttackValue", LuaScriptInterface::luaPokemonSpellSetAttackValue);
	registerMethod("PokemonSpell", "setNeedTarget", LuaScriptInterface::luaPokemonSpellSetNeedTarget);
	registerMethod("PokemonSpell", "setNeedDirection", LuaScriptInterface::luaPokemonSpellSetNeedDirection);
	registerMethod("PokemonSpell", "setCombatLength", LuaScriptInterface::luaPokemonSpellSetCombatLength);
	registerMethod("PokemonSpell", "setCombatSpread", LuaScriptInterface::luaPokemonSpellSetCombatSpread);
	registerMethod("PokemonSpell", "setCombatRadius", LuaScriptInterface::luaPokemonSpellSetCombatRadius);
	registerMethod("PokemonSpell", "setConditionType", LuaScriptInterface::luaPokemonSpellSetConditionType);
	registerMethod("PokemonSpell", "setConditionDamage", LuaScriptInterface::luaPokemonSpellSetConditionDamage);
	registerMethod("PokemonSpell", "setConditionSpeedChange", LuaScriptInterface::luaPokemonSpellSetConditionSpeedChange);
	registerMethod("PokemonSpell", "setConditionDuration", LuaScriptInterface::luaPokemonSpellSetConditionDuration);
	registerMethod("PokemonSpell", "setConditionDrunkenness", LuaScriptInterface::luaPokemonSpellSetConditionDrunkenness);
	registerMethod("PokemonSpell", "setConditionTickInterval", LuaScriptInterface::luaPokemonSpellSetConditionTickInterval);
	registerMethod("PokemonSpell", "setCombatShootEffect", LuaScriptInterface::luaPokemonSpellSetCombatShootEffect);
	registerMethod("PokemonSpell", "setCombatEffect", LuaScriptInterface::luaPokemonSpellSetCombatEffect);
	...
	registerMethod("Spell", "profession", LuaScriptInterface::luaSpellProfession);
	...
	registerMethod("MoveEvent", "profession", LuaScriptInterface::luaMoveEventProfession);
...
int LuaScriptInterface::luaAddModuleEvent(lua_State* L)
{
	//addModuleEvent(callback, delay, params)
	if (!isFunction(L, 1)) {
		reportErrorFunc(L, "callback parameter should be a function.");
	...
	if (lua_gettop(L) > 2) {
		if (!isTable(L, 3)) {
			reportErrorFunc(L, "params parameter should be a table.");
			lua_pushnil(L);
			return -1;
		}
	...
	uint32_t eventId = g_scheduler.getLastEventId();
	++eventId;
	g_scheduler.addEvent(createSchedulerTask(delay, std::bind(&LuaEnvironment::executeModuleEvent, &g_luaEnvironment, eventId, callback, tableRef)));

	auto& moduleTimerEvents = g_luaEnvironment.moduleTimerEvents;
	LuaModuleTimerEventDesc eventDesc { callback, tableRef };
	moduleTimerEvents.insert(std::make_pair(eventId, eventDesc));

	lua_pushnumber(L, eventId);
	return 1;
}

int LuaScriptInterface::luaStopModuleEvent(lua_State* L)
{
	//stopModuleEvent(eventId)
	uint32_t eventId = getNumber<uint32_t>(L, 1);
	g_scheduler.stopEvent(eventId);

	auto& moduleTimerEvents = g_luaEnvironment.moduleTimerEvents;

	if (moduleTimerEvents.find(eventId) != moduleTimerEvents.end()) {
		int32_t callback = moduleTimerEvents[eventId].callback;
		int32_t params = moduleTimerEvents[eventId].params;

		if (params != -1) {
			luaL_unref(L, LUA_REGISTRYINDEX, params);
		}
		...
		moduleTimerEvents.erase(eventId);
	}
...
int LuaScriptInterface::luaGameGetPokemonTypes(lua_State* L)
{
	// Game.getPokemonTypes()
	auto& type = g_pokemons.pokemons;
	lua_createtable(L, type.size(), 0);

	for (auto& pType : type) {
		pushUserdata<PokemonType>(L, &pType.second);
		setMetatable(L, -1, "PokemonType");
		lua_setfield(L, -2, pType.first.c_str());
	}
	return 1;
}

int LuaScriptInterface::luaGameGetPokeballInfo(lua_State* L)
{
	// Game.getPokeballInfo(id)
	uint16_t id{ 0 };
	if (isNumber(L, 1)){
		id = getNumber<uint16_t>(L, 1);
	}else {
		id = getUserdata<Pokeball>(L, 1)->getID();
	}

	PokeballInfo* pokeballInfo = g_pokeballs.getPokeballInfo(id);
	if (pokeballInfo) {
		lua_createtable(L, 0, 5);
		setField(L, "id", pokeballInfo->id);
		setField(L, "multiplier", pokeballInfo->multiplier);
		setField(L, "effectDelay", pokeballInfo->effectDelay);
		setField(L, "charged", pokeballInfo->charged);
		setField(L, "catchEffect", pokeballInfo->catchEffect);
		setField(L, "failEffect", pokeballInfo->failEffect);
		setField(L, "callEffect", pokeballInfo->callEffect);
		setField(L, "shotEffect", pokeballInfo->shotEffect);
	}
	else {
		lua_pushnil(L);
	}
...
int LuaScriptInterface::luaGameGetModularityEnviroment(lua_State* L)
{
	// Game.getModularityEnviroment()
	pushString(L, g_config.getString(ConfigManager::string_config_t::MOD_ENVIROMENT));
	return 1;
}
int LuaScriptInterface::luaGameGetLFSName(lua_State* L)
{
	// Game.getModularityEnviroment()
	pushString(L, g_config.getString(ConfigManager::string_config_t::LFS));
	return 1;
}
...
{
	// Game.createPokemon(pokemonName, position[, master = nil, extended = false[, force = false]])
	...
	if (lua_gettop(L) > 2) {
		master = getCreature(L, 3);
		if (master) {
			pokemon->setMaster(master);
		}
	}
...
int LuaScriptInterface::luaGameCreatePokemonType(lua_State* L)
{
	// Game.createPokemonType(name)
	...
	PokemonType* pokemonType = g_pokemons.getPokemonType(name, false);
	if (!pokemonType) {
		pokemonType = &g_pokemons.pokemons[asLowerCaseString(name)];
		pokemonType->name = name;
		pokemonType->nameDescription = "a " + name;
	} else {
		pokemonType->info.lootItems.clear();
		pokemonType->info.attackSpells.clear();
		pokemonType->info.defenseSpells.clear();
		pokemonType->info.scripts.clear();
		pokemonType->info.thinkEvent = -1;
		pokemonType->info.creatureAppearEvent = -1;
		pokemonType->info.creatureDisappearEvent = -1;
		pokemonType->info.creatureMoveEvent = -1;
		pokemonType->info.creatureSayEvent = -1;
	}
...
int LuaScriptInterface::luaSpellsClear(lua_State* L)
{
	// Spells.clear()
	g_spells->clear(true);
	return 1;
...
// Functions
int LuaScriptInterface::luaFunctionsGetPokemonNatureName(lua_State* L)
{
	// Functions.getPokemonNatureName(nature)
	if (lua_gettop(L) < 1) {
		std::cout << "[Warning - Functions::getPokemonNatureName] The nature parameter was not passed." << std::endl;
		lua_pushnil(L);
		return 1;
	}

	PokemonNature_t nature = static_cast<PokemonNature_t>(getNumber<uint8_t>(L, 1));
	pushString(L, getPokemonNatureName(nature));

	return 1;
}

int LuaScriptInterface::luaFunctionsGetPokemonGenderName(lua_State* L)
{
	// Functions.getPokemonGenderName(gender)
	if (lua_gettop(L) < 1) {
		std::cout << "[Warning - Functions::getPokemonGenderName] The gender parameter was not passed." << std::endl;
		lua_pushnil(L);
		return 1;
	}

	PokemonGender_t gender = static_cast<PokemonGender_t>(getNumber<uint8_t>(L, 1));
	pushString(L, getPokemonGenderName(gender));

	return 1;
}

int LuaScriptInterface::luaFunctionsGetPokemonTypeName(lua_State* L)
{
	// Functions.getPokemonTypeName(type)
	if (lua_gettop(L) < 1) {
		std::cout << "[Warning - Functions::getPokemonTypeName] The type parameter was not passed." << std::endl;
		lua_pushnil(L);
		return 1;
	}

	PokemonType_t type = static_cast<PokemonType_t>(getNumber<uint16_t>(L, 1));
	pushString(L, getPokemonTypeName(type));

	return 1;
}

int LuaScriptInterface::luaFunctionsGetPokemonExpForLevel(lua_State* L)
{
	// Functions.getPokemonExpForLevel(level)
	uint32_t level = getNumber<uint32_t>(L, 1);
	lua_pushnumber(L, Pokemon::getExpForLevel(level));
	return 1;
}

int LuaScriptInterface::luaFunctionsGetPokemonMaxHealth(lua_State* L)
{
	// Functions.getPokemonMaxHealth(name, level, gender, healthIv, healthEv)
	std::string name = getString(L, 1);
	uint32_t level = getNumber<uint32_t>(L, 2);
	uint8_t gender = getNumber<uint8_t>(L, 3);
	uint16_t healthIv = getNumber<uint16_t>(L, 4);
	uint16_t healthEv = getNumber<uint16_t>(L, 5);
	lua_pushnumber(L, Pokemon::getUpdatedMaxHealth(name, level, gender, healthIv, healthEv));
	return 1;
}
...
int LuaScriptInterface::luaItemGetParentContainer(lua_State* L)
{
	// item:getParentContainer()
	Item* item = getUserdata<Item>(L, 1);
	Container* container = item->getParent()->getContainer();
...
int LuaScriptInterface::luaItemGetCorpseName(lua_State* L)
{
	// item:getCorpseName()
	Item* item = getUserdata<Item>(L, 1);
	const ItemType& itemType = Item::items.getItemType(item->getID());

	if (item && itemType.isCorpse()) {
		pushString(L, item->getCorpseName());
	} else {
		pushBoolean(L, false);
	}
	return 1;
...
int LuaScriptInterface::luaItemGetPokemonCorpseIvs(lua_State* L)
{
	// item:getPokemonCorpseIvs()
	Item* item = getUserdata<Item>(L, 1);
	const ItemType& itemType = Item::items.getItemType(item->getID());

	if (item && itemType.isCorpse()) {
		PokemonValues ivs = item->getPokemonCorpseIvs();
		lua_createtable(L, 0, 6);
		setField(L, "attack", ivs.attack);
		setField(L, "defense", ivs.defense);
		setField(L, "health", ivs.health);
		setField(L, "specialAttack", ivs.specialAttack);
		setField(L, "specialDefense", ivs.specialDefense);
		setField(L, "speed", ivs.speed);
	}
	else {
		pushBoolean(L, false);
	}
...
int LuaScriptInterface::luaItemIsCuttable(lua_State* L)
{
	// item:isCuttable()
	Item* item = getUserdata<Item>(L, 1);
	if (item) {
		pushBoolean(L, item->isCuttable());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaItemIsDiggable(lua_State* L)
{
	// item:isDiggable()
	Item* item = getUserdata<Item>(L, 1);
	if (item) {
		pushBoolean(L, item->isDiggable());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaItemIsSmashable(lua_State* L)
{
	// item:isSmashable()
	Item* item = getUserdata<Item>(L, 1);
	if (item) {
		pushBoolean(L, item->isSmashable());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaPokeballCreate(lua_State* L)
{
	// Pokeball(item)
	Item* item = getUserdata<Item>(L, 2);
	Pokeball* pokeball = item->getPokeball();

	if (pokeball) {
		pushUserdata(L, pokeball);
...
int LuaScriptInterface::luaPokeballGetPokemon(lua_State* L)
{
	// pokeball:getPokemon()
...
int LuaScriptInterface::luaPokeballSetPokemon(lua_State* L)
{
...
int LuaScriptInterface::luaPokeballGetPokemonNickname(lua_State* L)
{
	// pokeball:getPokemonNickname()
	Pokeball* pokeball = getUserdata<Pokeball>(L, 1);

	if (pokeball) {
		pushString(L, pokeball->getPokemonNickname());
	}
	else {
		lua_pushnil(L);
	}
...
int LuaScriptInterface::luaPokeballSetPokemonNickname(lua_State* L)
{
	// pokeball:setPokemonNickname(name)
	Pokeball* pokeball = getUserdata<Pokeball>(L, 1);
	std::string name = getString(L, 2);
...
int LuaScriptInterface::luaPokeballGetPokemonIvs(lua_State* L)
{
	// pokeball:getPokemonIvs()
	Pokeball* pokeball = getUserdata<Pokeball>(L, 1);
	if (pokeball) {
		PokemonValues ivs = pokeball->getIvs();
		lua_createtable(L, 0, 6);
		setField(L, "attack", ivs.attack);
		setField(L, "defense", ivs.defense);
		setField(L, "health", ivs.health);
...
int LuaScriptInterface::luaPokeballSetPokemonIvs(lua_State* L)
{
	// pokeball:setPokemonIvs(attack, defense, health, specialAttack, specialDefense, speed)
	Pokeball* pokeball = getUserdata<Pokeball>(L, 1);
	if (pokeball) {
		if (lua_gettop(L) < 7) {
			std::cout << "[Warning - Pokeball::setPokemonIvs] The ivs parameters was not passed - (attack, defense, health, specialAttack, specialDefense, speed)." << std::endl;
			lua_pushnil(L);
			return 1;
		}

		uint16_t attack = getNumber<uint16_t>(L, 2);
		uint16_t defense = getNumber<uint16_t>(L, 3);
		uint16_t health = getNumber<uint16_t>(L, 4);
		uint16_t specialAttack = getNumber<uint16_t>(L, 5);
		uint16_t specialDefense = getNumber<uint16_t>(L, 6);
		uint16_t speed = getNumber<uint16_t>(L, 7);

		Pokemon::setPokemonValues(pokeball->getIvs(), attack, defense, health, specialAttack, specialDefense, speed);
	}
	else {
		lua_pushnil(L);
	}
...
int LuaScriptInterface::luaPokeballGetPokemonEvs(lua_State* L)
{
	// pokeball:getPokemonEvs()
	Pokeball* pokeball = getUserdata<Pokeball>(L, 1);
	if (pokeball) {
		PokemonValues evs = pokeball->getEvs();
		lua_createtable(L, 0, 6);
		setField(L, "attack", evs.attack);
		setField(L, "defense", evs.defense);
		setField(L, "health", evs.health);
		setField(L, "specialAttack", evs.specialAttack);
		setField(L, "specialDefense", evs.specialDefense);
		setField(L, "speed", evs.speed);
	}
	else {
		lua_pushnil(L);
	}
...
int LuaScriptInterface::luaPokeballSetPokemonEvs(lua_State* L)
{
	// pokeball:setPokemonEvs(attack, defense, health, specialAttack, specialDefense, speed)
	Pokeball* pokeball = getUserdata<Pokeball>(L, 1);
	if (pokeball) {
		if (lua_gettop(L) < 7) {
			std::cout << "[Warning - Pokeball::setPokemonIvs] The ivs parameters was not passed - (attack, defense, health, specialAttack, specialDefense, speed)." << std::endl;
		...
		Pokemon::setPokemonValues(pokeball->getEvs(), attack, defense, health, specialAttack, specialDefense, speed);
	}
	else {
		lua_pushnil(L);
	}
...
int LuaScriptInterface::luaPokeballGetPokemonLevel(lua_State* L)
{
	// pokeball:getPokemonLevel()
	Pokeball* pokeball = getUserdata<Pokeball>(L, 1);

	if (pokeball) {
		lua_pushnumber(L, pokeball->getPokemonLevel());
	}
	else {
		lua_pushnil(L);
	}
...
int LuaScriptInterface::luaPokeballSetPokemonLevel(lua_State* L)
{
...
int LuaScriptInterface::luaPokeballSetPokemonGender(lua_State* L)
{
	// pokeball:setPokemonGender(level)
	Pokeball* pokeball = getUserdata<Pokeball>(L, 1);
	uint8_t gender = getNumber<uint8_t>(L, 2);
...
int LuaScriptInterface::luaPokeballGetPokemonGender(lua_State* L)
{
	// pokeball:getPokemonGender()
	Pokeball* pokeball = getUserdata<Pokeball>(L, 1);

	if (pokeball) {
		lua_pushnumber(L, pokeball->getPokemonGender());
	}
	else {
		lua_pushnil(L);
	}
...
int LuaScriptInterface::luaPokeballSetPokemonNature(lua_State* L)
{
	// pokeball:setPokemonNature(nature)
	Pokeball* pokeball = getUserdata<Pokeball>(L, 1);
	uint8_t nature = getNumber<uint8_t>(L, 2);
...
int LuaScriptInterface::luaPokeballGetPokemonNature(lua_State* L)
{
	// pokeball:getPokemonNature()
	Pokeball* pokeball = getUserdata<Pokeball>(L, 1);

	if (pokeball) {
		lua_pushnumber(L, pokeball->getPokemonNature());
	}
	else {
		lua_pushnil(L);
	}
...
int LuaScriptInterface::luaPokeballSetPokemonExperience(lua_State* L)
{
...
int LuaScriptInterface::luaPokeballGetPokemonExperience(lua_State* L)
{
	// pokeball:getPokemonExperience()
	Pokeball* pokeball = getUserdata<Pokeball>(L, 1);

	if (pokeball) {
		lua_pushnumber(L, pokeball->getPokemonExperience());
	}
	else {
		lua_pushnil(L);
	}
...
int LuaScriptInterface::luaPokeballSetPokemonHealth(lua_State* L)
{
	// pokeball:setPokemonHealth(health)
	Pokeball* pokeball = getUserdata<Pokeball>(L, 1);
...
int LuaScriptInterface::luaPokeballGetPokemonHealth(lua_State* L)
{
	// pokeball:getPokemonHealth()
	Pokeball* pokeball = getUserdata<Pokeball>(L, 1);

	if (pokeball) {
		lua_pushnumber(L, pokeball->getPokemonHealth());
	}
	else {
		lua_pushnil(L);
	}
...
int LuaScriptInterface::luaPokeballGetInfo(lua_State* L)
{
	// pokeball:getInfo()
	Pokeball* pokeball = getUserdata<Pokeball>(L, 1);

	if (pokeball) {
		PokeballInfo* pokeballInfo = g_pokeballs.getPokeballInfo(pokeball->getInfoId());
		if (pokeballInfo) {
			lua_createtable(L, 0, 5);
			setField(L, "id", pokeballInfo->id);
			setField(L, "multiplier", pokeballInfo->multiplier);
...
int LuaScriptInterface::luaPokeballSetInfoId(lua_State* L)
{
	// pokeball:setInfoId(id)
	Pokeball* pokeball = getUserdata<Pokeball>(L, 1);

	if (pokeball) {
		pokeball->setInfoId(getNumber<uint16_t>(L, 2));
	}
	else {
		lua_pushnil(L);
	}
...
int LuaScriptInterface::luaPokeballGetState(lua_State* L)
{
	// pokeball:getState()
	Pokeball* pokeball = getUserdata<Pokeball>(L, 1);

	if (pokeball) {
		lua_pushnumber(L, pokeball->getState());
	}
	else {
		lua_pushnil(L);
	}
...
int LuaScriptInterface::luaPokeballSetState(lua_State* L)
{
	// pokeball:setState(state)
	Pokeball* pokeball = getUserdata<Pokeball>(L, 1);

	if (pokeball) {
		pokeball->setState(getNumber<uint8_t>(L, 2));
	}
	else {
		lua_pushnil(L);
	}
...
int LuaScriptInterface::luaPokeballGetPortrait(lua_State* L)
{
	// pokeball:getPortrait()
	Pokeball* pokeball = getUserdata<Pokeball>(L, 1);

	if (pokeball) {
		lua_pushnumber(L, pokeball->getPortrait());
	}
	else {
		lua_pushnil(L);
	}
...
int LuaScriptInterface::luaPokeballSetPortrait(lua_State* L)
{
	// pokeball:setPortrait(id)
	Pokeball* pokeball = getUserdata<Pokeball>(L, 1);

	if (pokeball) {
		pokeball->setPortrait(getNumber<uint32_t>(L, 2));
	}
	else {
		lua_pushnil(L);
	}
...
int LuaScriptInterface::luaPokeballRefresh(lua_State* L)
{
	// pokeball:refresh()
	Pokeball* pokeball = getUserdata<Pokeball>(L, 1);
...
int LuaScriptInterface::luaPokeballGetIvsStats(lua_State* L)
{
	// pokeball:getIvsStats()
	Pokeball* pokeball = getUserdata<Pokeball>(L, 1);

	if (pokeball) {
		pushString(L, pokeball->getIvsStats());
	}
	else {
		lua_pushnil(L);
	}
...
int LuaScriptInterface::luaPokeballUpdatePokemonAbilities(lua_State* L)
{
...
int LuaScriptInterface::luaPokeballResetMoveCooldown(lua_State* L)
{
	// pokeball:resetMoveCooldown(moveName)
	Pokeball* pokeball = getUserdata<Pokeball>(L, 1);
	...
	const std::string moveName = asLowerCaseString(getString(L, 2));
	pokeball->resetMoveCooldown(moveName);
...
int LuaScriptInterface::luaPokeballGetMoveOsTime(lua_State* L)
{
	// pokeball:getMoveOsTime(moveName)
	Pokeball* pokeball = getUserdata<Pokeball>(L, 1);
	...
	lua_pushnumber(L, pokeball->getMoveOsTime(moveName));
	return 1;
}

int LuaScriptInterface::luaPokeballGetMoveCooldown(lua_State* L)
{
	// pokeball:getMoveCooldown(moveName)
	Pokeball* pokeball = getUserdata<Pokeball>(L, 1);
	...
	lua_pushnumber(L, pokeball->getMoveCooldown(moveName));
	return 1;
}

int LuaScriptInterface::luaPokeballGetMoves(lua_State* L)
{
	// pokeball:getMoves()
	Pokeball* pokeball = getUserdata<Pokeball>(L, 1);
	if (!pokeball) {
	...
	lua_createtable(L, pokeball->getPokemonMoves().size(), 0);

	int index = 0;
	for (auto& [id, move] : pokeball->getPokemonMoves()) {
		lua_createtable(L, 0, 2);

		setField(L, "id", id);
		setField(L, "name", move.name);
		setField(L, "level", move.level);
...
int LuaScriptInterface::luaCreatureSetHealth(lua_State* L)
{
	...
	creature->setHealth(getNumber<uint32_t>(L, 2));
...
int LuaScriptInterface::luaCreatureAddHealth(lua_State* L)
{
	...
	if (damage.primary.value >= 0) {
		...
		damage.primary.type = COMBAT_NORMALDAMAGE;
	}
...
{
	// creature:say(text[, type = TALKTYPE_POKEMON_SAY[, ghost = false[, target = nullptr[, position]]]])
	int parameters = lua_gettop(L);
	...
	SpeakClasses type = getNumber<SpeakClasses>(L, 3, TALKTYPE_POKEMON_SAY);
	const std::string& text = getString(L, 2);
	Creature* creature = getUserdata<Creature>(L, 1);
	if (!creature) {
		lua_pushnil(L);
	...
	if (env) {
		echo = env->getScriptId() == g_events->getScriptId(EventInfoId::CREATURE_ONHEAR);
	}
...
int LuaScriptInterface::luaCreatureJump(lua_State* L)
{
	// creature:jump(time, height)
	Creature* creature = getUserdata<Creature>(L, 1);
	if (!creature) {
		lua_pushnil(L);
		return 1;
	...
	uint16_t height = getNumber<uint16_t>(L, 2);
	uint16_t duration = getNumber<uint16_t>(L, 3);

	g_game.addCreatureJump(creature, height, duration);
...
int LuaScriptInterface::luaCreatureAddTag(lua_State* L)
{
	// creature:addTag(name, [, value = ""])
	Creature* creature = getUserdata<Creature>(L, 1);
	if (!creature) {
		lua_pushboolean(L, false);
		return 1;
	...
	if (lua_gettop(L) > 2) {
		if (isNumber(L, 3)) {
			value = std::to_string(getNumber<long long>(L, 3));
		} else if (isString(L, 3)) {
			value = getString(L, 3);
		} else {
			lua_pushboolean(L, false);
	...
	lua_pushboolean(L, creature->addTag(name, value));
	return 1;
}

int LuaScriptInterface::luaCreatureAddTimedTag(lua_State* L)
{
	// creature:addTimedTag(name, duration, [,value = ""])
	Creature* creature = getUserdata<Creature>(L, 1);
	if (!creature) {
		lua_pushboolean(L, false);
		return 1;
	...
	if (lua_gettop(L) > 3) {
		if (isNumber(L, 4)) {
			value = std::to_string(getNumber<long long>(L, 4));
		} else if (isString(L, 4)) {
			value = getString(L, 4);
		} else {
			lua_pushboolean(L, false);
			return 1;
	...
	lua_pushboolean(L, creature->addTimedTag(name, duration, value));
	return 1;
}

int LuaScriptInterface::luaCreatureSetTag(lua_State* L)
{
	// creature:setTag(name, [, value = ""])
	Creature* creature = getUserdata<Creature>(L, 1);
	if (!creature) {
		lua_pushboolean(L, false);
		return 1;
	...
	lua_pushboolean(L, creature->setTag(name, value));
	return 1;
}

int LuaScriptInterface::luaCreatureRemoveTag(lua_State* L)
{
	// creature:removeTag(name)
	Creature* creature = getUserdata<Creature>(L, 1);
	if (!creature) {
		lua_pushboolean(L, false);
		return 1;
	...
	std::string name = getString(L, 2);
	lua_pushboolean(L, creature->removeTag(name));
	return 1;
}

int LuaScriptInterface::luaCreatureHasTag(lua_State* L)
{
	// creature:hasTag(name)
	Creature* creature = getUserdata<Creature>(L, 1);
	if (!creature) {
		lua_pushboolean(L, false);
		return 1;
	...
	std::string name = getString(L, 2);
	lua_pushboolean(L, creature->hasTag(name));
	return 1;
}

int LuaScriptInterface::luaCreatureGetTag(lua_State* L)
{
	// creature:getTag(name)
	Creature* creature = getUserdata<Creature>(L, 1);
	if (!creature) {
		lua_pushnil(L);
		return 1;
	...
	if (!creature->hasTag(name)) {
		lua_pushnil(L);
		return 1;
	}

	std::string tag = creature->getTag(name);

	try {
		long long value = std::stoi(tag);
...
int LuaScriptInterface::luaCreatureMoveToPosition(lua_State* L)
{
	// creature:moveToPosition(pos[, minTargetDist = 0[, maxTargetDist = 1[, fullPathSearch = true[, clearSight = true[, maxSearchDist = 0]]]]])
	Creature* creature = getUserdata<Creature>(L, 1);
	if (!creature) {
		lua_pushnil(L);
		return 1;
...
int LuaScriptInterface::luaPlayerCanLearnSpell(lua_State* L)
{
	...
	if (vocMap.count(player->getProfessionId()) == 0) {
		pushBoolean(L, false);
...
int LuaScriptInterface::luaPlayerUpdateContainer(lua_State* L)
{
	// player:updateContainer(container)
	Player* player = getUserdata<Player>(L, 1);
	Container* container = getUserdata<Container>(L, 2);
	...
	if (player && container) {
		for (const auto& it : player->openContainers){
			...
			g_game.playerUpdateContainer(player->getID(), it.first);
			break;
		}
	}
	else {
...
int LuaScriptInterface::luaPlayerUpdateContainerItem(lua_State* L)
{
	// player:updateContainerItem(container, item)
	Player* player = getUserdata<Player>(L, 1);
	Container* container = getUserdata<Container>(L, 2);
	const Item* item = getUserdata<Item>(L, 3);

	if (player && container && item) {
		for (const auto& it : player->openContainers) {
			const OpenContainer& openContainer = it.second;
			if (openContainer.container != container) {
				continue;
			...
			uint16_t slot = 0;
			for (const auto& it : openContainer.container->getItemList()) {
				if (it == item) {
					break;
				}
				slot += 1;
			}
			player->sendUpdateContainerItem(container, slot, item);
			break;
		}
	}
	else {
...
int LuaScriptInterface::luaPlayerSendInventoryItem(lua_State* L)
{
	// player:sendInventoryItem()
	Player* player = getUserdata<Player>(L, 1);
	slots_t slot = getNumber<slots_t>(L, 2, CONST_SLOT_WHEREEVER);
	const Item* item = getUserdata<Item>(L, 3);
...
int LuaScriptInterface::luaPlayerGetPokemon(lua_State* L)
{
	// player:getPokemon()
	Player* player = getUserdata<Player>(L, 1);
	if (!player) {
...
int LuaScriptInterface::luaPlayerSetPokemon(lua_State* L)
{
...
int LuaScriptInterface::luaPlayerGetPokeball(lua_State* L)
{
	// player:getPokeball()
	Player* player = getUserdata<Player>(L, 1);
	if (!player) {
	...
	Pokeball* pokeball = player->getPokeball();
	if (!pokeball) {
		lua_pushnil(L);
		return 1;
	}
...
int LuaScriptInterface::luaPlayerSetPokeball(lua_State* L)
{
	// player:setPokeball(pokeball)
	Player* player = getUserdata<Player>(L, 1);
	Pokeball* pokeball = getUserdata<Pokeball>(L, 2);
...
int LuaScriptInterface::luaPlayerIsFlying(lua_State* L)
{
	// player:isFlying()
	Player* player = getUserdata<Player>(L, 1);
	if (!player) {
	...
	pushBoolean(L, player->isFlying());
	return 1;
}

int LuaScriptInterface::luaPlayerSetFlying(lua_State* L)
{
...
int LuaScriptInterface::luaPokemonGetType(lua_State* L)
{
	...
	if (pokemon) {
		pushUserdata<PokemonType>(L, pokemon->pType);
		setMetatable(L, -1, "PokemonType");
	} else {
		lua_pushnil(L);
	}
...
int LuaScriptInterface::luaPokemonRename(lua_State* L)
{
	// pokemon:rename(name[, nameDescription])
	...
	pokemon->setName(getString(L, 2));
	if (lua_gettop(L) >= 3) {
		pokemon->setNameDescription(getString(L, 3));
	}
...
int LuaScriptInterface::luaPokemonIsWalkingToSpawn(lua_State* L)
{
	// pokemon:isWalkingToSpawn()
	Pokemon* pokemon = getUserdata<Pokemon>(L, 1);
	if (pokemon) {
		pushBoolean(L, pokemon->isWalkingToSpawn());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaPokemonWalkToSpawn(lua_State* L)
{
	// pokemon:walkToSpawn()
	Pokemon* pokemon = getUserdata<Pokemon>(L, 1);
	if (pokemon) {
		pushBoolean(L, pokemon->walkToSpawn());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaPokemonGetLevelPercent(lua_State* L)
{
	// pokemon:getLevelPercent()
	Pokemon* pokemon = getUserdata<Pokemon>(L, 1);
	if (pokemon) {
		lua_pushnumber(L, pokemon->getLevelPercent());
	}
	else {
		lua_pushnil(L);
	}
...
int LuaScriptInterface::luaPokemonSetLevel(lua_State* L)
{
	...
	Pokemon* pokemon = getUserdata<Pokemon>(L, 1);
	if (lua_gettop(L) < 2) {
		std::cout << "[Warning - Pokemon::setLevel] The level parameter was not passed." << std::endl;
		lua_pushnil(L);
		return 1;
	}
	uint32_t level = getNumber<uint32_t>(L, 2);
...
int LuaScriptInterface::luaPokemonSetExperience(lua_State* L)
{
	// pokemon:setExperience(exp)
	Pokemon* pokemon = getUserdata<Pokemon>(L, 1);
	if (lua_gettop(L) < 2) {
		std::cout << "[Warning - Pokemon::setExperience] The exp parameter was not passed." << std::endl;
		lua_pushnil(L);
		return 1;
	}
	uint32_t exp = getNumber<uint32_t>(L, 2);
...
int LuaScriptInterface::luaPokemonGetGender(lua_State* L)
{
	// pokemon:getGender()
	Pokemon* pokemon = getUserdata<Pokemon>(L, 1);
	if (pokemon) {
		lua_pushnumber(L, pokemon->getGender());
	}
	else {
		lua_pushnil(L);
	}
...
int LuaScriptInterface::luaPokemonSetGender(lua_State* L)
{
	// pokemon:setGender(gender)
	Pokemon* pokemon = getUserdata<Pokemon>(L, 1);
	if (lua_gettop(L) < 2) {
		std::cout << "[Warning - Pokemon::setGender] The gender parameter was not passed." << std::endl;
		lua_pushnil(L);
		return 1;
	}
	uint8_t gender = getNumber<uint8_t>(L, 2);
...
int LuaScriptInterface::luaPokemonGetIvs(lua_State* L)
{
	// pokemon:getIvs()
	Pokemon* pokemon = getUserdata<Pokemon>(L, 1);
	if (pokemon) {
		lua_createtable(L, 0, 6);
		setField(L, "attack", pokemon->ivs.attack);
		setField(L, "defense", pokemon->ivs.defense);
		setField(L, "health", pokemon->ivs.health);
		setField(L, "specialAttack", pokemon->ivs.specialAttack);
		setField(L, "specialDefense", pokemon->ivs.specialDefense);
		setField(L, "speed", pokemon->ivs.speed);
	}
	else {
		lua_pushnil(L);
	}
...
int LuaScriptInterface::luaPokemonSetIvs(lua_State* L)
{
	// pokemon:setIvs(attack, defense, health, specialAttack, specialDefense, speed)
	Pokemon* pokemon = getUserdata<Pokemon>(L, 1);
	if (pokemon) {
		if (lua_gettop(L) < 7) {
			std::cout << "[Warning - Pokemon::setIvs] The ivs parameters was not passed - (attack, defense, health, specialAttack, specialDefense, speed)." << std::endl;
			lua_pushnil(L);
			return 1;
		}
		...
		Pokemon::setPokemonValues(pokemon->ivs, attack, defense, health, specialAttack, specialDefense, speed);
	}
	else {
		lua_pushnil(L);
	}
...
int LuaScriptInterface::luaPokemonGetEvs(lua_State* L)
{
	// pokemon:getEvs()
	Pokemon* pokemon = getUserdata<Pokemon>(L, 1);
	if (pokemon) {
		lua_createtable(L, 0, 6);
		setField(L, "attack", pokemon->evs.attack);
		setField(L, "defense", pokemon->evs.defense);
		setField(L, "health", pokemon->evs.health);
		setField(L, "specialAttack", pokemon->evs.specialAttack);
		setField(L, "specialDefense", pokemon->evs.specialDefense);
		setField(L, "speed", pokemon->evs.speed);
	}
	else {
		lua_pushnil(L);
	}
...
int LuaScriptInterface::luaPokemonSetEvs(lua_State* L)
{
	// pokemon:setEvs(attack, defense, health, specialAttack, specialDefense, speed)
	Pokemon* pokemon = getUserdata<Pokemon>(L, 1);
	if (pokemon) {
		if (lua_gettop(L) < 7) {
			std::cout << "[Warning - Pokemon::setEvs] The evs parameters was not passed - (attack, defense, health, specialAttack, specialDefense, speed)." << std::endl;
			lua_pushnil(L);
			return 1;
		}
		...
		Pokemon::setPokemonValues(pokemon->evs, attack, defense, health, specialAttack, specialDefense, speed);
	}
	else {
		lua_pushnil(L);
	}
...
int LuaScriptInterface::luaPokemonSetEvAttack(lua_State* L)
{
	// pokemon:setEvAttack(attack)
	Pokemon* pokemon = getUserdata<Pokemon>(L, 1);
	if (pokemon) {
		pokemon->setEvAttack(getNumber<uint16_t>(L, 2));
	}
	else {
		lua_pushnil(L);
	}
...
int LuaScriptInterface::luaPokemonSetEvDefense(lua_State* L)
{
	// pokemon:setEvDefense(defense)
	Pokemon* pokemon = getUserdata<Pokemon>(L, 1);
	if (pokemon) {
		pokemon->setEvDefense(getNumber<uint16_t>(L, 2));
	}
	else {
		lua_pushnil(L);
	}
...
int LuaScriptInterface::luaPokemonSetEvHealth(lua_State* L)
{
	// pokemon:setEvHealth(health)
	Pokemon* pokemon = getUserdata<Pokemon>(L, 1);
	if (pokemon) {
		pokemon->setEvHealth(getNumber<uint16_t>(L, 2));
	}
	else {
		lua_pushnil(L);
	}
...
int LuaScriptInterface::luaPokemonSetEvSpecialAttack(lua_State* L)
{
	// pokemon:setEvSpecialAttack(specialAttack)
	Pokemon* pokemon = getUserdata<Pokemon>(L, 1);
	if (pokemon) {
		pokemon->setEvSpecialAttack(getNumber<uint16_t>(L, 2));
	}
	else {
		lua_pushnil(L);
	}
...
int LuaScriptInterface::luaPokemonSetEvSpecialDefense(lua_State* L)
{
	// pokemon:setEvSpecialDefense(specialDefense)
	Pokemon* pokemon = getUserdata<Pokemon>(L, 1);
	if (pokemon) {
		pokemon->setEvSpecialDefense(getNumber<uint16_t>(L, 2));
	}
	else {
		lua_pushnil(L);
	}
...
int LuaScriptInterface::luaPokemonSetEvSpeed(lua_State* L)
{
	// pokemon:setEvSpeed(speed)
	Pokemon* pokemon = getUserdata<Pokemon>(L, 1);
	if (pokemon) {
		pokemon->setEvSpeed(getNumber<uint16_t>(L, 2));
	}
	else {
		lua_pushnil(L);
	}
...
int LuaScriptInterface::luaPokemonSetNature(lua_State* L)
{
	// pokemon:setNature(nature)
	Pokemon* pokemon = getUserdata<Pokemon>(L, 1);
	if (pokemon) {
		if (lua_gettop(L) < 2) {
			std::cout << "[Warning - Pokemon::setNature] The nature parameter was not passed." << std::endl;
			lua_pushnil(L);
			return 1;
		}
		pokemon->setNature(getNumber<uint8_t>(L, 2));
	}
	else {
		lua_pushnil(L);
	}
...
int LuaScriptInterface::luaPokemonGetIvsStats(lua_State* L)
{
	// pokemon:getIvsStats()
	Pokemon* pokemon = getUserdata<Pokemon>(L, 1);
	if (pokemon) {
		pushString(L, pokemon->getIvsStats());
	}
	else {
		lua_pushnil(L);
	}
...
int LuaScriptInterface::luaPokemonUpdateMaxHealth(lua_State* L)
{
	// pokemon:updateMaxHealth()
	Pokemon* pokemon = getUserdata<Pokemon>(L, 1);
	if (pokemon) {
		pokemon->updateMaxHealth();
	}
...
int LuaScriptInterface::luaPokemonUpdateSpeed(lua_State* L)
{
	// pokemon:updateSpeed()
	Pokemon* pokemon = getUserdata<Pokemon>(L, 1);
	if (pokemon) {
...
int LuaScriptInterface::luaPokemonUpdateStatus(lua_State* L)
{
...
int LuaScriptInterface::luaPokemonCastSpell(lua_State* L)
{
	// pokemon:castSpell(spellName)
	Pokemon* pokemon = getUserdata<Pokemon>(L, 1);
	if (!pokemon) {
		lua_pushboolean(L, false);
		return 1;
	...
	if (Pokeball* pokeball = pokemon->getPokeball()) {
		uint32_t cooldown = pokeball->getMoveOsTime(spellName);

		if (cooldown > 0 && cooldown < spell->getCooldown()) {
			g_game.addMagicEffect(pokemon->getPosition(), CONST_ME_POFF);
			lua_pushboolean(L, false);
			return 1;
		}
	}

	pokemon->updateLookDirection();

	if (spell->getNeedTarget()) {
		...
		spell->castSpell(pokemon, target);
	} else {
		spell->castSpell(pokemon);
	}
...
int LuaScriptInterface::luaPokemonLearnMove(lua_State* L)
{
	// pokemon:learnMove(moveId, level, name)
	Pokemon* pokemon = getUserdata<Pokemon>(L, 1);
	if (!pokemon) {
		lua_pushboolean(L, false);
		return 1;
	...
	std::string moveName = asLowerCaseString(getString(L, 4));

	moveBlock_t move{ moveId, level, moveName };
	lua_pushboolean(L, pokemon->learnMove(move));
	return 1;
}

int LuaScriptInterface::luaPokemonHasMoveId(lua_State* L)
{
	// pokemon:hasMoveId(moveId)
	Pokemon* pokemon = getUserdata<Pokemon>(L, 1);
	if (!pokemon) {
		lua_pushboolean(L, false);
		return 1;
	...
	uint16_t moveId = getNumber<uint16_t>(L, 2);
	lua_pushboolean(L, pokemon->pType->hasMoveId(moveId));
	return 1;
}

int LuaScriptInterface::luaPokemonHasMoveByName(lua_State* L)
{
	// pokemon:hasMoveByName(moveName)
	Pokemon* pokemon = getUserdata<Pokemon>(L, 1);
	if (!pokemon) {
		lua_pushboolean(L, false);
		return 1;
	...
	lua_pushboolean(L, pokemon->hasMoveByName(moveName));
	return 1;
}

int LuaScriptInterface::luaPokemonEvolve(lua_State* L)
{
	// pokemon:evolve(stoneId)
	Pokemon* pokemon = getUserdata<Pokemon>(L, 1);
	if (!pokemon) {
		lua_pushboolean(L, false);
		return 1;
	...
	if (Creature* master = pokemon->getMaster()){
	...
	uint16_t stoneId = getNumber<uint16_t>(L, 2);
	std::string pokemonName;

	bool hasEvolution = pokemon->pType->evolutions.size() > 0;
	if (!hasEvolution) {
		if (player) {
			player->sendCancelMessage(RETURNVALUE_POKEMONCANNOTEVOLVE);
		}
		lua_pushboolean(L, false);
		return 1;
	}

	for (auto& [stone, evolution] : pokemon->pType->evolutions) {
		if (stone == stoneId) {
	...
	if (pokemonName.empty()) {
		if (player) {
			player->sendCancelMessage(RETURNVALUE_POKEMONCANNOTEVOLVEWITHTHISSTONE);
		}
		lua_pushboolean(L, false);
		return 1;
	}

	PokemonType* evolutionType = g_pokemons.getPokemonType(pokemonName);
	if (!evolutionType) {
		if (player) {
			player->sendCancelMessage(RETURNVALUE_POKEMONEVOLUTIONNOTFOUND);
		}
		lua_pushboolean(L, false);
		return 1;
	}

	if (player && player->getLevel() < evolutionType->info.requiredLevel) {
		player->sendCancelMessage(RETURNVALUE_NOLEVELTOEVOLVEPOKEMON);
		lua_pushboolean(L, false);
		return 1;
	}

	if (player) {
		if (!player->removeItemOfType(stoneId, 1, -1, false)) {
			reportErrorFunc(L, "Could not remove player item id: " + std::to_string(stoneId));
			return 1;
		}
	}

	Outfit_t outfit = pokemon->getCurrentOutfit();
	outfit.lookType = evolutionType->info.outfit.lookType;
	g_game.internalCreatureChangeOutfit(pokemon, outfit);

	pokemon->setName(evolutionType->name);
	pokemon->pType = evolutionType;
	pokemon->updateMaxHealth();
	...
	pokeball->setPokemonName(evolutionType->name);
	pokeball->setPortrait(evolutionType->info.portrait);
	pokeball->updatePokemonMoves();
	lua_pushboolean(L, true);
	return 1;
}

int LuaScriptInterface::luaPokemonLearnAbility(lua_State* L)
{
	// pokemon:learnAbility(ability)
	Pokemon* pokemon = getUserdata<Pokemon>(L, 1);
	if (!pokemon) {
		lua_pushboolean(L, false);
		return 1;
	...
	if (lua_gettop(L) < 2) {
		std::cout << "[Warning - Pokemon::learnAbility] The ability parameter was not passed." << std::endl;
		lua_pushboolean(L, false);
		return 1;
	}

	const std::string ability = getString(L, 2);
	lua_pushboolean(L, pokemon->learnAbility(ability));
	return 1;
}

int LuaScriptInterface::luaPokemonHasAbility(lua_State* L)
{
	...
	if (lua_gettop(L) < 2) {
		std::cout << "[Warning - Pokemon::hasAbility] The ability parameter was not passed." << std::endl;
		lua_pushboolean(L, false);
		return 1;
	}

	const std::string ability = getString(L, 2);
	lua_pushboolean(L, pokemon->hasAbility(ability));
	return 1;
}

int LuaScriptInterface::luaPokemonGetStatusHealth(lua_State* L)
{
	// pokemon:getStatusHealth()
	Pokemon* pokemon = getUserdata<Pokemon>(L, 1);
	if (!pokemon) {
		lua_pushnil(L);
		return 1;
	...
	lua_pushnumber(L, pokemon->getStatusHealth());
	return 1;
}

int LuaScriptInterface::luaPokemonGetStatusAttack(lua_State* L)
{
	// pokemon:getStatusAttack()
	Pokemon* pokemon = getUserdata<Pokemon>(L, 1);
	if (!pokemon) {
		lua_pushnil(L);
		return 1;
	...
	lua_pushnumber(L, pokemon->getStatusAttack());
	return 1;
}

int LuaScriptInterface::luaPokemonGetStatusDefense(lua_State* L)
{
	// pokemon:getStatusDefense()
	Pokemon* pokemon = getUserdata<Pokemon>(L, 1);
	if (!pokemon) {
		lua_pushnil(L);
		return 1;
	...
	lua_pushnumber(L, pokemon->getStatusDefense());
	return 1;
}

int LuaScriptInterface::luaPokemonGetStatusSpecialAttack(lua_State* L)
{
	// pokemon:getStatusSpecialAttack()
	Pokemon* pokemon = getUserdata<Pokemon>(L, 1);
	if (!pokemon) {
		lua_pushnil(L);
		return 1;
	...
	lua_pushnumber(L, pokemon->getStatusSpecialAttack());
	return 1;
}

int LuaScriptInterface::luaPokemonGetStatusSpecialDefense(lua_State* L)
{
	// pokemon:getStatusSpecialDefense()
	Pokemon* pokemon = getUserdata<Pokemon>(L, 1);
	if (!pokemon) {
		lua_pushnil(L);
		return 1;
	...
	lua_pushnumber(L, pokemon->getStatusSpecialDefense());
	return 1;
}

int LuaScriptInterface::luaPokemonGetStatusSpeed(lua_State* L)
{
	// pokemon:getStatusSpeed()
	Pokemon* pokemon = getUserdata<Pokemon>(L, 1);
	if (!pokemon) {
		lua_pushnil(L);
		return 1;
	...
	lua_pushnumber(L, pokemon->getStatusSpeed());
	return 1;
}

int LuaScriptInterface::luaPokemonIsHoldingPosition(lua_State* L)
{
	// pokemon:isHoldingPosition()
	Pokemon* pokemon = getUserdata<Pokemon>(L, 1);
	if (!pokemon) {
		lua_pushnil(L);
		return 1;
	...
	lua_pushboolean(L, pokemon->isHoldingPosition());
	return 1;
}

int LuaScriptInterface::luaPokemonSetHoldPosition(lua_State* L)
{
	// pokemon:setHoldPosition(bool)
	Pokemon* pokemon = getUserdata<Pokemon>(L, 1);
	if (!pokemon) {
		lua_pushnil(L);
		return 1;
	...
	bool holdPosition = getBoolean(L, 2);
	pokemon->setHoldPosition(holdPosition);
	return 1;
}

int LuaScriptInterface::luaPokemonGetOrderPosition(lua_State* L)
{
	// pokemon:getOrderPosition()
	Pokemon* pokemon = getUserdata<Pokemon>(L, 1);
	if (!pokemon) {
		lua_pushnil(L);
		return 1;
	...
	pushPosition(L, pokemon->getOrderPosition());
	return 1;
}

int LuaScriptInterface::luaPokemonSetOrderPosition(lua_State* L)
{
	// pokemon:setOrderPosition(position)
	Pokemon* pokemon = getUserdata<Pokemon>(L, 1);
	if (!pokemon) {
		lua_pushnil(L);
		return 1;
...
int LuaScriptInterface::luaProfessionGetName(lua_State* L)
{
	...
	Profession* profession = getUserdata<Profession>(L, 1);
	if (profession) {
		pushString(L, profession->getVocName());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaProfessionGetDescription(lua_State* L)
{
	...
	Profession* profession = getUserdata<Profession>(L, 1);
	if (profession) {
		pushString(L, profession->getVocDescription());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaProfessionGetAttackSpeed(lua_State* L)
{
	// profession:getAttackSpeed()
	Profession* profession = getUserdata<Profession>(L, 1);
	if (profession) {
		lua_pushnumber(L, profession->getAttackSpeed());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaProfessionAllowsPvp(lua_State* L)
{
	// profession:allowsPvp()
	Profession* profession = getUserdata<Profession>(L, 1);
	if (profession) {
		pushBoolean(L, profession->allowsPvp());
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaItemTypeGetProfessionString(lua_State* L)
{
	// itemType:getProfessionString()
	const ItemType* itemType = getUserdata<const ItemType>(L, 1);
	if (itemType) {
		pushString(L, itemType->professionString);
	} else {
		lua_pushnil(L);
	}
	return 1;
...
{
	// get: pokemonType:isAttackable() set: pokemonType:isAttackable(bool)
	PokemonType* pokemonType = getUserdata<PokemonType>(L, 1);
	if (pokemonType) {
		if (lua_gettop(L) == 1) {
			pushBoolean(L, pokemonType->info.isAttackable);
		} else {
			pokemonType->info.isAttackable = getBoolean(L, 2);
			pushBoolean(L, true);
		}
	} else {
		lua_pushnil(L);
...
int LuaScriptInterface::luaPokemonTypeIsChallengeable(lua_State* L)
{
	// get: pokemonType:isChallengeable() set: pokemonType:isChallengeable(bool)
	PokemonType* pokemonType = getUserdata<PokemonType>(L, 1);
	if (pokemonType) {
		if (lua_gettop(L) == 1) {
			pushBoolean(L, pokemonType->info.isChallengeable);
		} else {
			pokemonType->info.isChallengeable = getBoolean(L, 2);
			pushBoolean(L, true);
		}
	} else {
		lua_pushnil(L);
...
{
	// get: pokemonType:isConvinceable() set: pokemonType:isConvinceable(bool)
	PokemonType* pokemonType = getUserdata<PokemonType>(L, 1);
	if (pokemonType) {
		if (lua_gettop(L) == 1) {
			pushBoolean(L, pokemonType->info.isConvinceable);
		} else {
			pokemonType->info.isConvinceable = getBoolean(L, 2);
			pushBoolean(L, true);
		}
	} else {
		lua_pushnil(L);
...
{
	// get: pokemonType:isSummonable() set: pokemonType:isSummonable(bool)
	PokemonType* pokemonType = getUserdata<PokemonType>(L, 1);
	if (pokemonType) {
		if (lua_gettop(L) == 1) {
			pushBoolean(L, pokemonType->info.isSummonable);
		} else {
			pokemonType->info.isSummonable = getBoolean(L, 2);
			pushBoolean(L, true);
		}
	} else {
		lua_pushnil(L);
...
int LuaScriptInterface::luaPokemonTypeIsIgnoringSpawnBlock(lua_State* L)
{
	// get: pokemonType:isIgnoringSpawnBlock() set: pokemonType:isIgnoringSpawnBlock(bool)
	PokemonType* pokemonType = getUserdata<PokemonType>(L, 1);
	if (pokemonType) {
		if (lua_gettop(L) == 1) {
			pushBoolean(L, pokemonType->info.isIgnoringSpawnBlock);
		} else {
			pokemonType->info.isIgnoringSpawnBlock = getBoolean(L, 2);
			pushBoolean(L, true);
		}
	} else {
		lua_pushnil(L);
...
{
	// get: pokemonType:isIllusionable() set: pokemonType:isIllusionable(bool)
	PokemonType* pokemonType = getUserdata<PokemonType>(L, 1);
	if (pokemonType) {
		if (lua_gettop(L) == 1) {
			pushBoolean(L, pokemonType->info.isIllusionable);
		} else {
			pokemonType->info.isIllusionable = getBoolean(L, 2);
			pushBoolean(L, true);
		}
	} else {
		lua_pushnil(L);
...
{
	// get: pokemonType:isHostile() set: pokemonType:isHostile(bool)
	PokemonType* pokemonType = getUserdata<PokemonType>(L, 1);
	if (pokemonType) {
		if (lua_gettop(L) == 1) {
			pushBoolean(L, pokemonType->info.isHostile);
		} else {
			pokemonType->info.isHostile = getBoolean(L, 2);
			pushBoolean(L, true);
		}
	} else {
		lua_pushnil(L);
...
{
	// get: pokemonType:isPushable() set: pokemonType:isPushable(bool)
	PokemonType* pokemonType = getUserdata<PokemonType>(L, 1);
	if (pokemonType) {
		if (lua_gettop(L) == 1) {
			pushBoolean(L, pokemonType->info.pushable);
		} else {
			pokemonType->info.pushable = getBoolean(L, 2);
			pushBoolean(L, true);
		}
	} else {
		lua_pushnil(L);
...
int LuaScriptInterface::luaPokemonTypeIsHealthHidden(lua_State* L)
{
	// get: pokemonType:isHealthHidden() set: pokemonType:isHealthHidden(bool)
	PokemonType* pokemonType = getUserdata<PokemonType>(L, 1);
	if (pokemonType) {
		if (lua_gettop(L) == 1) {
			pushBoolean(L, pokemonType->info.hiddenHealth);
		} else {
			pokemonType->info.hiddenHealth = getBoolean(L, 2);
			pushBoolean(L, true);
		}
	} else {
		lua_pushnil(L);
...
int LuaScriptInterface::luaPokemonTypeIsBoss(lua_State* L)
{
	// get: pokemonType:isBoss() set: pokemonType:isBoss(bool)
	PokemonType* pokemonType = getUserdata<PokemonType>(L, 1);
	if (pokemonType) {
		if (lua_gettop(L) == 1) {
			pushBoolean(L, pokemonType->info.isBoss);
		} else {
			pokemonType->info.isBoss = getBoolean(L, 2);
			pushBoolean(L, true);
		}
	} else {
		lua_pushnil(L);
...
{
	// get: pokemonType:canPushItems() set: pokemonType:canPushItems(bool)
	PokemonType* pokemonType = getUserdata<PokemonType>(L, 1);
	if (pokemonType) {
		if (lua_gettop(L) == 1) {
			pushBoolean(L, pokemonType->info.canPushItems);
		} else {
			pokemonType->info.canPushItems = getBoolean(L, 2);
			pushBoolean(L, true);
		}
	} else {
		lua_pushnil(L);
...
{
	// get: pokemonType:canPushCreatures() set: pokemonType:canPushCreatures(bool)
	PokemonType* pokemonType = getUserdata<PokemonType>(L, 1);
	if (pokemonType) {
		if (lua_gettop(L) == 1) {
			pushBoolean(L, pokemonType->info.canPushCreatures);
		} else {
			pokemonType->info.canPushCreatures = getBoolean(L, 2);
			pushBoolean(L, true);
		}
	} else {
		lua_pushnil(L);
...
int LuaScriptInterface::luaPokemonTypeCanWalkOnEnergy(lua_State* L)
{
	// get: pokemonType:canWalkOnEnergy() set: pokemonType:canWalkOnEnergy(bool)
	PokemonType* pokemonType = getUserdata<PokemonType>(L, 1);
	if (pokemonType) {
		if (lua_gettop(L) == 1) {
			pushBoolean(L, pokemonType->info.canWalkOnEnergy);
		} else {
			pokemonType->info.canWalkOnEnergy = getBoolean(L, 2);
			pushBoolean(L, true);
		}
	} else {
		lua_pushnil(L);
...
int LuaScriptInterface::luaPokemonTypeCanWalkOnFire(lua_State* L)
{
	// get: pokemonType:canWalkOnFire() set: pokemonType:canWalkOnFire(bool)
	PokemonType* pokemonType = getUserdata<PokemonType>(L, 1);
	if (pokemonType) {
		if (lua_gettop(L) == 1) {
			pushBoolean(L, pokemonType->info.canWalkOnFire);
		} else {
			pokemonType->info.canWalkOnFire = getBoolean(L, 2);
			pushBoolean(L, true);
		}
	} else {
		lua_pushnil(L);
...
int LuaScriptInterface::luaPokemonTypeCanWalkOnPoison(lua_State* L)
{
	// get: pokemonType:canWalkOnPoison() set: pokemonType:canWalkOnPoison(bool)
	PokemonType* pokemonType = getUserdata<PokemonType>(L, 1);
	if (pokemonType) {
		if (lua_gettop(L) == 1) {
			pushBoolean(L, pokemonType->info.canWalkOnPoison);
		} else {
			pokemonType->info.canWalkOnPoison = getBoolean(L, 2);
			pushBoolean(L, true);
		}
	} else {
		lua_pushnil(L);
...
int LuaScriptInterface::luaPokemonTypeCanLearnAbility(lua_State* L)
{
	// pokemonType:canLearnAbility(ability)
	PokemonType* pokemonType = getUserdata<PokemonType>(L, 1);
	if (!pokemonType) {
		lua_pushnil(L);
		return 1;
	...
	const std::string ability = asLowerCaseString(getString(L, 2));

	pushBoolean(L, pokemonType->canLearnAbility(ability));
	return 1;
}

int LuaScriptInterface::luaPokemonTypeCanLearnMove(lua_State* L)
{
	// pokemonType:canLearnMove(move)
	PokemonType* pokemonType = getUserdata<PokemonType>(L, 1);
	if (!pokemonType) {
		lua_pushnil(L);
		return 1;
	...
	pushBoolean(L, pokemonType->canLearnMove(moveName));
	return 1;
}

int32_t LuaScriptInterface::luaPokemonTypeName(lua_State* L)
{
	// get: pokemonType:name() set: pokemonType:name(name)
	PokemonType* pokemonType = getUserdata<PokemonType>(L, 1);
	if (pokemonType) {
		if (lua_gettop(L) == 1) {
			pushString(L, pokemonType->name);
		} else {
			pokemonType->name = getString(L, 2);
			pushBoolean(L, true);
		}
	} else {
		lua_pushnil(L);
...
int LuaScriptInterface::luaPokemonTypeNameDescription(lua_State* L)
{
	// get: pokemonType:nameDescription() set: pokemonType:nameDescription(desc)
	PokemonType* pokemonType = getUserdata<PokemonType>(L, 1);
	if (pokemonType) {
		if (lua_gettop(L) == 1) {
			pushString(L, pokemonType->nameDescription);
		} else {
			pokemonType->nameDescription = getString(L, 2);
			pushBoolean(L, true);
		}
	} else {
		lua_pushnil(L);
...
int LuaScriptInterface::luaPokemonTypeGenderMalePercent(lua_State* L)
{
	// get: pokemonType:genderMalePercent() set: pokemonType:genderMalePercent(double)
	PokemonType* pokemonType = getUserdata<PokemonType>(L, 1);
	if (pokemonType) {
		if (lua_gettop(L) == 1) {
			lua_pushnumber(L, pokemonType->info.genderMalePercent);
		} else {
			pokemonType->info.genderMalePercent = getNumber<double>(L, 2);
			pushBoolean(L, true);
		}
	} else {
		lua_pushnil(L);
...
int LuaScriptInterface::luaPokemonTypeGenderFemalePercent(lua_State* L)
{
	// get: pokemonType:genderFemalePercent() set: pokemonType:genderFemalePercent(double)
	PokemonType* pokemonType = getUserdata<PokemonType>(L, 1);
	if (pokemonType) {
		if (lua_gettop(L) == 1) {
			lua_pushnumber(L, pokemonType->info.genderFemalePercent);
		} else {
			pokemonType->info.genderFemalePercent = getNumber<double>(L, 2);
			pushBoolean(L, true);
		}
	} else {
		lua_pushnil(L);
...
int LuaScriptInterface::luaPokemonTypeMinSpawnLevel(lua_State* L)
{
	// get: pokemonType:minSpawnLevel() set: pokemonType:minSpawnLevel(level)
	PokemonType* pokemonType = getUserdata<PokemonType>(L, 1);
	if (pokemonType) {
		if (lua_gettop(L) == 1) {
			lua_pushnumber(L, pokemonType->info.minSpawnLevel);
		} else {
			pokemonType->info.minSpawnLevel = getNumber<uint32_t>(L, 2);
			pushBoolean(L, true);
		}
	} else {
		lua_pushnil(L);
...
int LuaScriptInterface::luaPokemonTypeMaxSpawnLevel(lua_State* L)
{
	// get: pokemonType:maxSpawnLevel() set: pokemonType:maxSpawnLevel(level)
	PokemonType* pokemonType = getUserdata<PokemonType>(L, 1);
	if (pokemonType) {
		if (lua_gettop(L) == 1) {
			lua_pushnumber(L, pokemonType->info.maxSpawnLevel);
		} else {
			pokemonType->info.maxSpawnLevel = getNumber<uint32_t>(L, 2);
			pushBoolean(L, true);
		}
	} else {
		lua_pushnil(L);
...
int LuaScriptInterface::luaPokemonTypeHealth(lua_State* L)
{
	// get: pokemonType:health() set: pokemonType:health(health)
	PokemonType* pokemonType = getUserdata<PokemonType>(L, 1);
	if (pokemonType) {
		if (lua_gettop(L) == 1) {
			lua_pushnumber(L, pokemonType->info.health);
		} else {
			pokemonType->info.health = getNumber<int32_t>(L, 2);
			pushBoolean(L, true);
		}
	} else {
		lua_pushnil(L);
...
int LuaScriptInterface::luaPokemonTypeMaxHealth(lua_State* L)
{
	// get: pokemonType:maxHealth() set: pokemonType:maxHealth(health)
	PokemonType* pokemonType = getUserdata<PokemonType>(L, 1);
	if (pokemonType) {
		if (lua_gettop(L) == 1) {
			lua_pushnumber(L, pokemonType->info.healthMax);
		} else {
			pokemonType->info.healthMax = getNumber<int32_t>(L, 2);
			pushBoolean(L, true);
		}
	} else {
		lua_pushnil(L);
...
int LuaScriptInterface::luaPokemonTypeRunHealth(lua_State* L)
{
	// get: pokemonType:runHealth() set: pokemonType:runHealth(health)
	PokemonType* pokemonType = getUserdata<PokemonType>(L, 1);
	if (pokemonType) {
		if (lua_gettop(L) == 1) {
			lua_pushnumber(L, pokemonType->info.runAwayHealth);
		} else {
			pokemonType->info.runAwayHealth = getNumber<int32_t>(L, 2);
			pushBoolean(L, true);
		}
	} else {
		lua_pushnil(L);
...
int LuaScriptInterface::luaPokemonTypeExperience(lua_State* L)
{
	// get: pokemonType:experience() set: pokemonType:experience(exp)
	PokemonType* pokemonType = getUserdata<PokemonType>(L, 1);
	if (pokemonType) {
		if (lua_gettop(L) == 1) {
			lua_pushnumber(L, pokemonType->info.experience);
		} else {
			pokemonType->info.experience = getNumber<uint64_t>(L, 2);
			pushBoolean(L, true);
		}
	} else {
		lua_pushnil(L);
...
int LuaScriptInterface::luaPokemonTypeSkull(lua_State* L)
{
	// get: pokemonType:skull() set: pokemonType:skull(str/constant)
	PokemonType* pokemonType = getUserdata<PokemonType>(L, 1);
	if (pokemonType) {
		if (lua_gettop(L) == 1) {
			lua_pushnumber(L, pokemonType->info.skull);
		} else {
			if (isNumber(L, 2)) {
				pokemonType->info.skull = getNumber<Skulls_t>(L, 2);
			} else {
				pokemonType->info.skull = getSkullType(getString(L, 2));
			}
			pushBoolean(L, true);
		}
	} else {
...
{
	// get: pokemonType:catchRate() set: pokemonType:catchRate(rate)
	PokemonType* pokemonType = getUserdata<PokemonType>(L, 1);
	if (pokemonType) {
		if (lua_gettop(L) == 1) {
			lua_pushnumber(L, pokemonType->info.catchRate);
		} else {
			pokemonType->info.catchRate = getNumber<uint32_t>(L, 2);
			pushBoolean(L, true);
		}
	} else {
		lua_pushnil(L);
...
int LuaScriptInterface::luaPokemonTypePortrait(lua_State* L)
{
	// get: pokemonType:portrait() set: pokemonType:portrait(id)
	PokemonType* pokemonType = getUserdata<PokemonType>(L, 1);
	if (pokemonType) {
		if (lua_gettop(L) == 1) {
			lua_pushnumber(L, pokemonType->info.portrait);
		}
		else {
			pokemonType->info.portrait = getNumber<uint32_t>(L, 2);
			pushBoolean(L, true);
		}
	}
	else {
...
int LuaScriptInterface::luaPokemonTypeCombatImmunities(lua_State* L)
{
	// get: pokemonType:combatImmunities() set: pokemonType:combatImmunities(immunity)
	PokemonType* pokemonType = getUserdata<PokemonType>(L, 1);
	if (pokemonType) {
		if (lua_gettop(L) == 1) {
			...
			if (immunity == "normal") {
				pokemonType->info.damageImmunities |= COMBAT_NORMALDAMAGE;
				pushBoolean(L, true);
			} else if (immunity == "energy") {
				pokemonType->info.damageImmunities |= COMBAT_ELETRICDAMAGE;
				pushBoolean(L, true);
			} else if (immunity == "fire") {
				pokemonType->info.damageImmunities |= COMBAT_FIREDAMAGE;
				pushBoolean(L, true);
			} else if (immunity == "rock") {
				pokemonType->info.damageImmunities |= COMBAT_ROCKDAMAGE;
				pushBoolean(L, true);
			} else if (immunity == "bug") {
				pokemonType->info.damageImmunities |= COMBAT_BUGDAMAGE;
				pushBoolean(L, true);
			} else if (immunity == "ice") {
				pokemonType->info.damageImmunities |= COMBAT_ICEDAMAGE;
				pushBoolean(L, true);
			} else if (immunity == "psychic") {
				pokemonType->info.damageImmunities |= COMBAT_PSYCHICDAMAGE;
				pushBoolean(L, true);
			} else if (immunity == "water") {
				pokemonType->info.damageImmunities |= COMBAT_WATERDAMAGE;
				pushBoolean(L, true);
			} else if (immunity == "fairy") {
				pokemonType->info.damageImmunities |= COMBAT_FAIRYDAMAGE;
				pushBoolean(L, true);
			} else if (immunity == "fighting") {
				pokemonType->info.damageImmunities |= COMBAT_FIGHTINGDAMAGE;
				pushBoolean(L, true);
			} else if (immunity == "steel") {
				pokemonType->info.damageImmunities |= COMBAT_STEELDAMAGE;
				pushBoolean(L, true);
			} else if (immunity == "flying") {
				pokemonType->info.damageImmunities |= COMBAT_FLYINGDAMAGE;
				pushBoolean(L, true);
			} else if (immunity == "dark") {
				pokemonType->info.damageImmunities |= COMBAT_DARKDAMAGE;
				pushBoolean(L, true);
			} else if (immunity == "ghost") {
				pokemonType->info.damageImmunities |= COMBAT_GHOSTDAMAGE;
				pushBoolean(L, true);
			} else if (immunity == "dragon") {
				pokemonType->info.damageImmunities |= COMBAT_DRAGONDAMAGE;
				pushBoolean(L, true);
			} else if (immunity == "ground") {
				pokemonType->info.damageImmunities |= COMBAT_GROUNDDAMAGE;
				pushBoolean(L, true);
			} else if (immunity == "lifedrain") {
				pokemonType->info.damageImmunities |= COMBAT_POISONDAMAGE;
				pushBoolean(L, true);
			} else {
...
int LuaScriptInterface::luaPokemonTypeAddMove(lua_State* L)
{
	// pokemonType:addMove(id, level, name)
	PokemonType* pokemonType = getUserdata<PokemonType>(L, 1);
	if (!pokemonType) {
		lua_pushnil(L);
		return 1;
	...
	moveBlock_t move{ moveId, level, moveName };
	pushBoolean(L, pokemonType->addMove(move));
	return 1;
}

int LuaScriptInterface::luaPokemonTypeAddLearnableAbility(lua_State* L)
{
	// pokemonType:addLearnableAbility(ability)
	PokemonType* pokemonType = getUserdata<PokemonType>(L, 1);
	if (!pokemonType) {
		lua_pushnil(L);
		return 1;
	...
	std::string ability = asLowerCaseString(getString(L, 2));

	pushBoolean(L, pokemonType->addLearnableAbility(ability));
	return 1;
}

int LuaScriptInterface::luaPokemonTypeAddLearnableMove(lua_State* L)
{
	// pokemonType:addLearnableMove(move)
	PokemonType* pokemonType = getUserdata<PokemonType>(L, 1);
	if (!pokemonType) {
		lua_pushnil(L);
		return 1;
	...
	pushBoolean(L, pokemonType->addLearnableMove(moveName));
	return 1;
}

int LuaScriptInterface::luaPokemonTypeAddEvolution(lua_State* L)
{
	// pokemonType:addEvolution(name, stone, level)
	PokemonType* pokemonType = getUserdata<PokemonType>(L, 1);
	if (!pokemonType) {
		pushBoolean(L, false);
		return 1;
	...
	const std::string name = asLowerCaseString(getString(L, 2));
	const std::string stone = asLowerCaseString(getString(L, 3));
	uint16_t level = getNumber<uint16_t>(L, 4);

	uint16_t stoneId = Item::items.getItemIdByName(stone);
	if (stoneId == 0) {
		std::cout << "[Warning - LuaScriptInterface::luaPokemonTypeAddEvolution] Not found item id with name: " << stone << std::endl;
		pushBoolean(L, false);
		return 1;
	}

	evolutionBlock_t evolution {level, name};
	pokemonType->evolutions.insert(std::make_pair(stoneId, evolution));

	pushBoolean(L, true);
	return 1;
}

int LuaScriptInterface::luaPokemonTypeConditionImmunities(lua_State* L)
{
	// get: pokemonType:conditionImmunities() set: pokemonType:conditionImmunities(immunity)
	PokemonType* pokemonType = getUserdata<PokemonType>(L, 1);
	if (pokemonType) {
		if (lua_gettop(L) == 1) {
			...
			std::string immunity = getString(L, 2);
			if (immunity == "normal") {
				pokemonType->info.conditionImmunities |= CONDITION_BLEEDING;
				pushBoolean(L, true);
			} else if (immunity == "energy") {
				pokemonType->info.conditionImmunities |= CONDITION_ENERGY;
				pushBoolean(L, true);
			} else if (immunity == "fire") {
				pokemonType->info.conditionImmunities |= CONDITION_FIRE;
				pushBoolean(L, true);
			} else if (immunity == "poison" || immunity == "earth") {
				pokemonType->info.conditionImmunities |= CONDITION_POISON;
				pushBoolean(L, true);
			} else if (immunity == "drown") {
				pokemonType->info.conditionImmunities |= CONDITION_DROWN;
				pushBoolean(L, true);
			} else if (immunity == "ice") {
				pokemonType->info.conditionImmunities |= CONDITION_FREEZING;
				pushBoolean(L, true);
			} else if (immunity == "holy") {
				pokemonType->info.conditionImmunities |= CONDITION_DAZZLED;
				pushBoolean(L, true);
			} else if (immunity == "death") {
				pokemonType->info.conditionImmunities |= CONDITION_CURSED;
				pushBoolean(L, true);
			} else if (immunity == "paralyze") {
				pokemonType->info.conditionImmunities |= CONDITION_PARALYZE;
				pushBoolean(L, true);
			} else if (immunity == "outfit") {
				pokemonType->info.conditionImmunities |= CONDITION_OUTFIT;
				pushBoolean(L, true);
			} else if (immunity == "drunk") {
				pokemonType->info.conditionImmunities |= CONDITION_DRUNK;
				pushBoolean(L, true);
			} else if (immunity == "invisible" || immunity == "invisibility") {
				pokemonType->info.conditionImmunities |= CONDITION_INVISIBLE;
				pushBoolean(L, true);
...
int LuaScriptInterface::luaPokemonTypeAddAttack(lua_State* L)
{
	// pokemonType:addAttack(pokemonspell)
	PokemonType* pokemonType = getUserdata<PokemonType>(L, 1);
	if (pokemonType) {
		PokemonSpell* spell = getUserdata<PokemonSpell>(L, 2);
		if (spell) {
			spellBlock_t sb;
			if (g_pokemons.deserializeSpell(spell, sb, pokemonType->name)) {
				pokemonType->info.attackSpells.push_back(std::move(sb));
			} else {
				std::cout << pokemonType->name << std::endl;
				std::cout << "[Warning - Pokemons::loadPokemon] Cant load spell. " << spell->name << std::endl;
			}
		} else {
			lua_pushnil(L);
		}
...
int LuaScriptInterface::luaPokemonTypeAddDefense(lua_State* L)
{
	// pokemonType:addDefense(pokemonspell)
	PokemonType* pokemonType = getUserdata<PokemonType>(L, 1);
	if (pokemonType) {
		PokemonSpell* spell = getUserdata<PokemonSpell>(L, 2);
		if (spell) {
			spellBlock_t sb;
			if (g_pokemons.deserializeSpell(spell, sb, pokemonType->name)) {
				pokemonType->info.defenseSpells.push_back(std::move(sb));
			} else {
				std::cout << pokemonType->name << std::endl;
				std::cout << "[Warning - Pokemons::loadPokemon] Cant load spell. " << spell->name << std::endl;
			}
...
int LuaScriptInterface::luaPokemonTypeAddElement(lua_State* L)
{
	// pokemonType:addElement(type, percent)
	PokemonType* pokemonType = getUserdata<PokemonType>(L, 1);
	if (pokemonType) {
		CombatType_t element = getNumber<CombatType_t>(L, 2);
		pokemonType->info.elementMap[element] = getNumber<int32_t>(L, 3);
		pushBoolean(L, true);
	} else {
		lua_pushnil(L);
	}
...
int LuaScriptInterface::luaPokemonTypeAddVoice(lua_State* L)
{
	// pokemonType:addVoice(sentence, interval, chance, yell)
	PokemonType* pokemonType = getUserdata<PokemonType>(L, 1);
	if (pokemonType) {
		voiceBlock_t voice;
		voice.text = getString(L, 2);
		pokemonType->info.yellSpeedTicks = getNumber<uint32_t>(L, 3);
		pokemonType->info.yellChance = getNumber<uint32_t>(L, 4);
		voice.yellText = getBoolean(L, 5);
		pokemonType->info.voiceVector.push_back(voice);
		pushBoolean(L, true);
	} else {
		lua_pushnil(L);
	}
...
int LuaScriptInterface::luaPokemonTypeGetLoot(lua_State* L)
{
	...
	pushLoot(L, pokemonType->info.lootItems);
	return 1;
}

int LuaScriptInterface::luaPokemonTypeAddLoot(lua_State* L)
{
	// pokemonType:addLoot(loot)
	PokemonType* pokemonType = getUserdata<PokemonType>(L, 1);
	if (pokemonType) {
		Loot* loot = getUserdata<Loot>(L, 2);
		if (loot) {
			pokemonType->loadLoot(pokemonType, loot->lootBlock);
			pushBoolean(L, true);
		} else {
			lua_pushnil(L);
		}
...
int LuaScriptInterface::luaPokemonTypeEventOnCallback(lua_State* L)
{
	// pokemonType:onThink(callback)
	// pokemonType:onAppear(callback)
	// pokemonType:onDisappear(callback)
	// pokemonType:onMove(callback)
	// pokemonType:onSay(callback)
	PokemonType* pokemonType = getUserdata<PokemonType>(L, 1);
	if (pokemonType) {
		if (pokemonType->loadCallback(&g_scripts->getScriptInterface())) {
			pushBoolean(L, true);
			return 1;
		}
		pushBoolean(L, false);
...
int LuaScriptInterface::luaPokemonTypeEventType(lua_State* L)
{
	// pokemontype:eventType(event)
	PokemonType* pokemonType = getUserdata<PokemonType>(L, 1);
	if (pokemonType) {
		pokemonType->info.eventType = getNumber<PokemonsEvent_t>(L, 2);
		pushBoolean(L, true);
	} else {
		lua_pushnil(L);
	}
...
int LuaScriptInterface::luaPokemonTypeAddSummon(lua_State* L)
{
	// pokemonType:addSummon(name, interval, chance[, max = -1])
	PokemonType* pokemonType = getUserdata<PokemonType>(L, 1);
	if (pokemonType) {
		...
		pokemonType->info.summons.push_back(summon);
		pushBoolean(L, true);
	} else {
		lua_pushnil(L);
	}
...
int LuaScriptInterface::luaPokemonTypeMaxSummons(lua_State* L)
{
	// get: pokemonType:maxSummons() set: pokemonType:maxSummons(ammount)
	PokemonType* pokemonType = getUserdata<PokemonType>(L, 1);
	if (pokemonType) {
		if (lua_gettop(L) == 1) {
			lua_pushnumber(L, pokemonType->info.maxSummons);
		} else {
			pokemonType->info.maxSummons = getNumber<uint32_t>(L, 2);
			pushBoolean(L, true);
		}
	} else {
		lua_pushnil(L);
...
int LuaScriptInterface::luaPokemonTypeArmor(lua_State* L)
{
	// get: pokemonType:armor() set: pokemonType:armor(armor)
	PokemonType* pokemonType = getUserdata<PokemonType>(L, 1);
	if (pokemonType) {
		if (lua_gettop(L) == 1) {
			lua_pushnumber(L, pokemonType->info.armor);
		} else {
			pokemonType->info.armor = getNumber<int32_t>(L, 2);
			pushBoolean(L, true);
		}
	} else {
		lua_pushnil(L);
...
int LuaScriptInterface::luaPokemonTypeDefense(lua_State* L)
{
	// get: pokemonType:defense() set: pokemonType:defense(defense)
	PokemonType* pokemonType = getUserdata<PokemonType>(L, 1);
	if (pokemonType) {
		if (lua_gettop(L) == 1) {
			lua_pushnumber(L, pokemonType->info.defense);
		} else {
			pokemonType->info.defense = getNumber<int32_t>(L, 2);
			pushBoolean(L, true);
		}
	} else {
		lua_pushnil(L);
...
int LuaScriptInterface::luaPokemonTypeOutfit(lua_State* L)
{
	// get: pokemonType:outfit() set: pokemonType:outfit(outfit)
	PokemonType* pokemonType = getUserdata<PokemonType>(L, 1);
	if (pokemonType) {
		if (lua_gettop(L) == 1) {
...
int LuaScriptInterface::luaPokemonTypeFirstType(lua_State* L)
{
	// get: pokemonType:firstType() set: pokemonType:firstType(type)
	PokemonType* pokemonType = getUserdata<PokemonType>(L, 1);
	...
	if (lua_gettop(L) == 1) { // get
		...
		uint16_t typeNumber = getNumber<uint16_t>(L, 2);
		if (typeNumber > POKEMON_TYPE_LAST) {
			std::cout << "[Warning - Pokemons::loadPokemon] Unknown pokemon type " << typeNumber << "." << std::endl;
			lua_pushboolean(L, false);
			return 1;
		}
		PokemonType_t type = static_cast<PokemonType_t>(typeNumber);
		pokemonType->info.firstType = type;
		lua_pushboolean(L, true);
	}
...
int LuaScriptInterface::luaPokemonTypeSecondType(lua_State* L)
{
	// get: pokemonType:secondType() set: pokemonType:secondType(type)
	PokemonType* pokemonType = getUserdata<PokemonType>(L, 1);
	...
	if (lua_gettop(L) == 1) { // get
		...
		PokemonType_t type = static_cast<PokemonType_t>(typeNumber);
		pokemonType->info.secondType = type;
		lua_pushboolean(L, true);
	}
...
int LuaScriptInterface::luaPokemonTypeCorpseId(lua_State* L)
{
	// get: pokemonType:corpseId() set: pokemonType:corpseId(id)
	PokemonType* pokemonType = getUserdata<PokemonType>(L, 1);
	if (pokemonType) {
		if (lua_gettop(L) == 1) {
			lua_pushnumber(L, pokemonType->info.lookcorpse);
		} else {
			pokemonType->info.lookcorpse = getNumber<uint16_t>(L, 2);
			lua_pushboolean(L, true);
		}
	} else {
		lua_pushnil(L);
...
int LuaScriptInterface::luaPokemonTypeLight(lua_State* L)
{
	// get: pokemonType:light() set: pokemonType:light(color, level)
	PokemonType* pokemonType = getUserdata<PokemonType>(L, 1);
	if (!pokemonType) {
		lua_pushnil(L);
		return 1;
	...
	if (lua_gettop(L) == 1) {
		...
		pokemonType->info.light.color = getNumber<uint8_t>(L, 2);
		pokemonType->info.light.level = getNumber<uint8_t>(L, 3);
		pushBoolean(L, true);
	}
	return 1;
}

int LuaScriptInterface::luaPokemonTypeStaticAttackChance(lua_State* L)
{
	// get: pokemonType:staticAttackChance() set: pokemonType:staticAttackChance(chance)
	PokemonType* pokemonType = getUserdata<PokemonType>(L, 1);
	if (pokemonType) {
		if (lua_gettop(L) == 1) {
			lua_pushnumber(L, pokemonType->info.staticAttackChance);
		} else {
			pokemonType->info.staticAttackChance = getNumber<uint32_t>(L, 2);
			pushBoolean(L, true);
		}
	} else {
		lua_pushnil(L);
...
int LuaScriptInterface::luaPokemonTypeTargetDistance(lua_State* L)
{
	// get: pokemonType:targetDistance() set: pokemonType:targetDistance(distance)
	PokemonType* pokemonType = getUserdata<PokemonType>(L, 1);
	if (pokemonType) {
		if (lua_gettop(L) == 1) {
			lua_pushnumber(L, pokemonType->info.targetDistance);
		} else {
			pokemonType->info.targetDistance = getNumber<int32_t>(L, 2);
			pushBoolean(L, true);
		}
	} else {
		lua_pushnil(L);
...
int LuaScriptInterface::luaPokemonTypeYellChance(lua_State* L)
{
	// get: pokemonType:yellChance() set: pokemonType:yellChance(chance)
	PokemonType* pokemonType = getUserdata<PokemonType>(L, 1);
	if (pokemonType) {
		if (lua_gettop(L) == 1) {
			lua_pushnumber(L, pokemonType->info.yellChance);
		} else {
			pokemonType->info.yellChance = getNumber<uint32_t>(L, 2);
			pushBoolean(L, true);
		}
	} else {
		lua_pushnil(L);
...
int LuaScriptInterface::luaPokemonTypeYellSpeedTicks(lua_State* L)
{
	// get: pokemonType:yellSpeedTicks() set: pokemonType:yellSpeedTicks(rate)
	PokemonType* pokemonType = getUserdata<PokemonType>(L, 1);
	if (pokemonType) {
		if (lua_gettop(L) == 1) {
			lua_pushnumber(L, pokemonType->info.yellSpeedTicks);
		} else {
			pokemonType->info.yellSpeedTicks = getNumber<uint32_t>(L, 2);
			pushBoolean(L, true);
		}
	} else {
		lua_pushnil(L);
...
int LuaScriptInterface::luaPokemonTypeChangeTargetChance(lua_State* L)
{
	// get: pokemonType:changeTargetChance() set: pokemonType:changeTargetChance(chance)
	PokemonType* pokemonType = getUserdata<PokemonType>(L, 1);
	if (pokemonType) {
		if (lua_gettop(L) == 1) {
			lua_pushnumber(L, pokemonType->info.changeTargetChance);
		} else {
			pokemonType->info.changeTargetChance = getNumber<int32_t>(L, 2);
			pushBoolean(L, true);
		}
	} else {
		lua_pushnil(L);
...
int LuaScriptInterface::luaPokemonTypeChangeTargetSpeed(lua_State* L)
{
	// get: pokemonType:changeTargetSpeed() set: pokemonType:changeTargetSpeed(speed)
	PokemonType* pokemonType = getUserdata<PokemonType>(L, 1);
	if (pokemonType) {
		if (lua_gettop(L) == 1) {
			lua_pushnumber(L, pokemonType->info.changeTargetSpeed);
		} else {
			pokemonType->info.changeTargetSpeed = getNumber<uint32_t>(L, 2);
			pushBoolean(L, true);
		}
	} else {
		lua_pushnil(L);
...
int LuaScriptInterface::luaPokemonTypeGetEvolutions(lua_State* L)
{
	// pokemonType:getEvolutions()
	PokemonType* pokemonType = getUserdata<PokemonType>(L, 1);
	if (!pokemonType) {
		lua_pushnil(L);
		return 1;
	...
	lua_createtable(L, pokemonType->evolutions.size(), 0);

	int index = 0;
	for (auto& [stoneId, evolution] : pokemonType->evolutions) {
		lua_createtable(L, 0, 2);

		setField(L, "stoneId", stoneId);
		setField(L, "name", evolution.name);
		setField(L, "level", evolution.level);
...
int LuaScriptInterface::luaPokemonTypeGetMoves(lua_State* L)
{
	// pokemonType:getMoves()
	PokemonType* pokemonType = getUserdata<PokemonType>(L, 1);
	if (!pokemonType) {
		lua_pushnil(L);
		return 1;
	...
	lua_createtable(L, pokemonType->moves.size(), 0);

	int index = 0;
	for (auto& [id, move] : pokemonType->moves) {
		lua_createtable(L, 0, 2);
...
int LuaScriptInterface::luaPokemonTypeNationalNumber(lua_State* L)
{
	// get: pokemonType:nationalNumber() set: pokemonType:nationalNumber(value)
	PokemonType* pokemonType = getUserdata<PokemonType>(L, 1);
	if (pokemonType) {
		if (lua_gettop(L) == 1) {
			lua_pushnumber(L, pokemonType->info.nationalNumber);
		} else {
			pokemonType->info.nationalNumber = getNumber<int32_t>(L, 2);
			pushBoolean(L, true);
		}
	} else {
		lua_pushnil(L);
...
int LuaScriptInterface::luaPokemonTypeDescription(lua_State* L)
{
	// get: pokemonType:description() set: pokemonType:description(value)
	PokemonType* pokemonType = getUserdata<PokemonType>(L, 1);
	if (pokemonType) {
		if (lua_gettop(L) == 1) {
			pushString(L, pokemonType->info.description);
		} else {
			pokemonType->info.description = std::move(getString(L, 2));
			pushBoolean(L, true);
		}
	} else {
		lua_pushnil(L);
...
{
	// get: pokemonType:height() set: pokemonType:height(value)
	PokemonType* pokemonType = getUserdata<PokemonType>(L, 1);
	if (pokemonType) {
		if (lua_gettop(L) == 1) {
...
{
	// get: pokemonType:weight() set: pokemonType:weight(value)
	PokemonType* pokemonType = getUserdata<PokemonType>(L, 1);
	if (pokemonType) {
		if (lua_gettop(L) == 1) {
...
int LuaScriptInterface::luaPokemonTypeGetRandomGender(lua_State* L)
{
	// pokemonType:getRandomGender()
	PokemonType* pokemonType = getUserdata<PokemonType>(L, 1);
	if (!pokemonType) {
		lua_pushnil(L);
		return 1;
	...
	lua_pushnumber(L, pokemonType->getRandomGender());
	return 1;
}

int LuaScriptInterface::luaPokemonTypeRequiredLevel(lua_State* L)
{
	// get: pokemonType:requiredLevel() set: pokemonType:requiredLevel(level)
	PokemonType* pokemonType = getUserdata<PokemonType>(L, 1);
	if (pokemonType) {
		if (lua_gettop(L) == 1) {
			lua_pushnumber(L, pokemonType->info.requiredLevel);
		} else {
			pokemonType->info.requiredLevel = getNumber<uint32_t>(L, 2);
			pushBoolean(L, true);
		}
	} else {
		lua_pushnil(L);
...
int LuaScriptInterface::luaPokemonTypeBaseHealth(lua_State* L)
{
	// get: pokemonType:baseHealth() set: pokemonType:baseHealth(health)
	PokemonType* pokemonType = getUserdata<PokemonType>(L, 1);
	if (pokemonType) {
		if (lua_gettop(L) == 1) {
			lua_pushnumber(L, pokemonType->baseStats.health);
		} else {
			pokemonType->baseStats.health = getNumber<uint16_t>(L, 2);
			pushBoolean(L, true);
		}
	} else {
		lua_pushnil(L);
...
int LuaScriptInterface::luaPokemonTypeBaseAttack(lua_State* L)
{
	// get: pokemonType:baseAttack() set: pokemonType:baseAttack(attack)
	PokemonType* pokemonType = getUserdata<PokemonType>(L, 1);
	if (pokemonType) {
		if (lua_gettop(L) == 1) {
			lua_pushnumber(L, pokemonType->baseStats.attack);
		} else {
			pokemonType->baseStats.attack = getNumber<uint16_t>(L, 2);
			pushBoolean(L, true);
		}
	} else {
		lua_pushnil(L);
...
int LuaScriptInterface::luaPokemonTypeBaseDefense(lua_State* L)
{
	// get: pokemonType:baseDefense() set: pokemonType:baseDefense(defense)
	PokemonType* pokemonType = getUserdata<PokemonType>(L, 1);
	if (pokemonType) {
		if (lua_gettop(L) == 1) {
			lua_pushnumber(L, pokemonType->baseStats.defense);
		} else {
			pokemonType->baseStats.defense = getNumber<uint16_t>(L, 2);
			pushBoolean(L, true);
		}
	} else {
		lua_pushnil(L);
...
int LuaScriptInterface::luaPokemonTypeBaseSpecialAttack(lua_State* L)
{
	// get: pokemonType:baseSpecialAttack() set: pokemonType:baseSpecialAttack(specialAttack)
	PokemonType* pokemonType = getUserdata<PokemonType>(L, 1);
	if (pokemonType) {
		if (lua_gettop(L) == 1) {
			lua_pushnumber(L, pokemonType->baseStats.specialAttack);
		} else {
			pokemonType->baseStats.specialAttack = getNumber<uint16_t>(L, 2);
			pushBoolean(L, true);
		}
	} else {
		lua_pushnil(L);
...
int LuaScriptInterface::luaPokemonTypeBaseSpecialDefense(lua_State* L)
{
	// get: pokemonType:baseSpecialDefense() set: pokemonType:baseSpecialDefense(specialDefense)
	PokemonType* pokemonType = getUserdata<PokemonType>(L, 1);
	if (pokemonType) {
		if (lua_gettop(L) == 1) {
			lua_pushnumber(L, pokemonType->baseStats.specialDefense);
		} else {
			pokemonType->baseStats.specialDefense = getNumber<uint16_t>(L, 2);
			pushBoolean(L, true);
		}
	} else {
		lua_pushnil(L);
...
{
	// get: pokemonType:baseSpeed() set: pokemonType:baseSpeed(speed)
	PokemonType* pokemonType = getUserdata<PokemonType>(L, 1);
	if (pokemonType) {
		if (lua_gettop(L) == 1) {
			lua_pushnumber(L, pokemonType->baseStats.speed);
		} else {
			pokemonType->baseStats.speed = getNumber<uint16_t>(L, 2);
			pushBoolean(L, true);
		}
	} else {
		lua_pushnil(L);
...
// PokemonSpell
int LuaScriptInterface::luaCreatePokemonSpell(lua_State* L)
{
	// PokemonSpell() will create a new Pokemon Spell
	PokemonSpell* spell = new PokemonSpell();
	if (spell) {
		pushUserdata<PokemonSpell>(L, spell);
		setMetatable(L, -1, "PokemonSpell");
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaDeletePokemonSpell(lua_State* L)
{
	// pokemonSpell:delete() pokemonSpell:__gc()
	PokemonSpell** pokemonSpellPtr = getRawUserdata<PokemonSpell>(L, 1);
	if (pokemonSpellPtr && *pokemonSpellPtr) {
		delete *pokemonSpellPtr;
		*pokemonSpellPtr = nullptr;
	}
	return 0;
}

int LuaScriptInterface::luaPokemonSpellSetType(lua_State* L)
{
	// pokemonSpell:setType(type)
	PokemonSpell* spell = getUserdata<PokemonSpell>(L, 1);
	if (spell) {
...
int LuaScriptInterface::luaPokemonSpellSetScriptName(lua_State* L)
{
	// pokemonSpell:setScriptName(name)
	PokemonSpell* spell = getUserdata<PokemonSpell>(L, 1);
	if (spell) {
...
int LuaScriptInterface::luaPokemonSpellSetChance(lua_State* L)
{
	// pokemonSpell:setChance(chance)
	PokemonSpell* spell = getUserdata<PokemonSpell>(L, 1);
	if (spell) {
...
int LuaScriptInterface::luaPokemonSpellSetInterval(lua_State* L)
{
	// pokemonSpell:setInterval(interval)
	PokemonSpell* spell = getUserdata<PokemonSpell>(L, 1);
	if (spell) {
...
int LuaScriptInterface::luaPokemonSpellSetRange(lua_State* L)
{
	// pokemonSpell:setRange(range)
	PokemonSpell* spell = getUserdata<PokemonSpell>(L, 1);
	if (spell) {
...
int LuaScriptInterface::luaPokemonSpellSetCombatValue(lua_State* L)
{
	// pokemonSpell:setCombatValue(min, max)
	PokemonSpell* spell = getUserdata<PokemonSpell>(L, 1);
	if (spell) {
...
int LuaScriptInterface::luaPokemonSpellSetCombatType(lua_State* L)
{
	// pokemonSpell:setCombatType(combatType_t)
	PokemonSpell* spell = getUserdata<PokemonSpell>(L, 1);
	if (spell) {
...
int LuaScriptInterface::luaPokemonSpellSetAttackValue(lua_State* L)
{
	// pokemonSpell:setAttackValue(attack, skill)
	PokemonSpell* spell = getUserdata<PokemonSpell>(L, 1);
	if (spell) {
...
int LuaScriptInterface::luaPokemonSpellSetNeedTarget(lua_State* L)
{
	// pokemonSpell:setNeedTarget(bool)
	PokemonSpell* spell = getUserdata<PokemonSpell>(L, 1);
	if (spell) {
...
int LuaScriptInterface::luaPokemonSpellSetNeedDirection(lua_State* L)
{
	// pokemonSpell:setNeedDirection(bool)
	PokemonSpell* spell = getUserdata<PokemonSpell>(L, 1);
	if (spell) {
...
int LuaScriptInterface::luaPokemonSpellSetCombatLength(lua_State* L)
{
	// pokemonSpell:setCombatLength(length)
	PokemonSpell* spell = getUserdata<PokemonSpell>(L, 1);
	if (spell) {
...
int LuaScriptInterface::luaPokemonSpellSetCombatSpread(lua_State* L)
{
	// pokemonSpell:setCombatSpread(spread)
	PokemonSpell* spell = getUserdata<PokemonSpell>(L, 1);
	if (spell) {
...
int LuaScriptInterface::luaPokemonSpellSetCombatRadius(lua_State* L)
{
	// pokemonSpell:setCombatRadius(radius)
	PokemonSpell* spell = getUserdata<PokemonSpell>(L, 1);
	if (spell) {
...
int LuaScriptInterface::luaPokemonSpellSetConditionType(lua_State* L)
{
	// pokemonSpell:setConditionType(type)
	PokemonSpell* spell = getUserdata<PokemonSpell>(L, 1);
	if (spell) {
...
int LuaScriptInterface::luaPokemonSpellSetConditionDamage(lua_State* L)
{
	// pokemonSpell:setConditionDamage(min, max, start)
	PokemonSpell* spell = getUserdata<PokemonSpell>(L, 1);
	if (spell) {
...
int LuaScriptInterface::luaPokemonSpellSetConditionSpeedChange(lua_State* L)
{
	// pokemonSpell:setConditionSpeedChange(minSpeed[, maxSpeed])
	PokemonSpell* spell = getUserdata<PokemonSpell>(L, 1);
	if (spell) {
...
int LuaScriptInterface::luaPokemonSpellSetConditionDuration(lua_State* L)
{
	// pokemonSpell:setConditionDuration(duration)
	PokemonSpell* spell = getUserdata<PokemonSpell>(L, 1);
	if (spell) {
...
int LuaScriptInterface::luaPokemonSpellSetConditionDrunkenness(lua_State* L)
{
	// pokemonSpell:setConditionDrunkenness(drunkenness)
	PokemonSpell* spell = getUserdata<PokemonSpell>(L, 1);
	if (spell) {
...
int LuaScriptInterface::luaPokemonSpellSetConditionTickInterval(lua_State* L)
{
	// pokemonSpell:setConditionTickInterval(interval)
	PokemonSpell* spell = getUserdata<PokemonSpell>(L, 1);
	if (spell) {
...
int LuaScriptInterface::luaPokemonSpellSetCombatShootEffect(lua_State* L)
{
	// pokemonSpell:setCombatShootEffect(effect)
	PokemonSpell* spell = getUserdata<PokemonSpell>(L, 1);
	if (spell) {
...
int LuaScriptInterface::luaPokemonSpellSetCombatEffect(lua_State* L)
{
	// pokemonSpell:setCombatEffect(effect)
	PokemonSpell* spell = getUserdata<PokemonSpell>(L, 1);
	if (spell) {
...
int LuaScriptInterface::luaSpellCreate(lua_State* L)
{
	...
	// Spell(type) ex: Spell(SPELL_INSTANT) to create a new spell
	if (lua_gettop(L) == 1) {
...
int LuaScriptInterface::luaSpellProfession(lua_State* L)
{
	// spell:profession(profession)
	Spell* spell = getUserdata<Spell>(L, 1);
	if (!spell) {
		lua_pushnil(L);
		return 1;
	...
	if (lua_gettop(L) == 1) {
		...
		for (auto& voc : spell->getVocMap()) {
			std::string name = g_professions.getProfession(voc.first)->getVocName();
			pushString(L, name);
			lua_rawseti(L, -2, ++i);
		}
	} else {
		...
		for (int i = 0; i < parameters; ++i) {
			...
			spell->addVocMap(g_professions.getProfessionId(vocList[0]), vocList.size() > 1 ? booleanString(vocList[1]) : false);
		}
		pushBoolean(L, true);
	}
	return 1;
...
int LuaScriptInterface::luaMoveEventProfession(lua_State* L)
{
	// moveevent:profession(vocName[, showInDescription = false, lastVoc = false])
	MoveEvent* moveevent = getUserdata<MoveEvent>(L, 1);
	if (moveevent) {
		...
		if (showInDescription) {
			if (moveevent->getProfessionString().empty()) {
				tmp = asLowerCaseString(getString(L, 2));
				tmp += "s";
				moveevent->setProfessionString(tmp);
			} else {
				tmp = moveevent->getProfessionString();
				if (lastVoc) {
					tmp += " and ";
				} else {
					tmp += ", ";
...
int LuaScriptInterface::luaGlobalEventType(lua_State* L)
{
	...
	if (global) {
		...
		if (tmpStr == "startup") {
			...
			std::cout << "[Error - LuaScriptInterface::luaGlobalEventType] Invalid type for global event: " << typeName << std::endl;
			pushBoolean(L, false);
		}
		pushBoolean(L, true);
	} else {
...
void LuaEnvironment::executeModuleEvent(uint32_t eventIndex, int32_t callback, int32_t tableRef)
{
	...
	auto& moduleTimerEvents = g_luaEnvironment.moduleTimerEvents;
	if (moduleTimerEvents.find(eventIndex) != moduleTimerEvents.end()) {
		moduleTimerEvents.erase(eventIndex);
	}
}
