...
class ConfigManager
{
	public:
		...
		enum boolean_config_t {
			...
			REMOVE_ON_DESPAWN,
			PLAYER_CONSOLE_LOGS,
			POKEMON_SYSTEM_LEVEL,
			POKEMON_SYSTEM_GENDER,
			POKEMON_SYSTEM_BOOST,
			POKEMON_FEATURE_LEVEL,
			POKEMON_FEATURE_GENDER,
			POKEMON_FEATURE_BOOST,
			POKEBALL_FEATURE_PORTRAIT,
