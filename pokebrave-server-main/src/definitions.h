...
static constexpr auto STATUS_SERVER_NAME = "The PBrave Server";
static constexpr auto STATUS_SERVER_VERSION = "1.x";
static constexpr auto STATUS_SERVER_DEVELOPERS = "The PBrave Team (Dark, Kroy and Yato)";
...
#define JOBSSCHEDULER_THREADS std::thread::hardware_concurrency()
